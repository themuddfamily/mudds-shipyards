...
- Next action: retain the candidate and withheld optimization; capture the exact rejection if it recurs. Separately profile a short planetary slice to distinguish production snapshot cost from recurring diagnostic/reentrant calls added by this long fixture. Do not change movement, support, rebase or handoff authority without a reproduced cause.
