...
func _run() -> void:
	...
	_check(
		...
		"resident geometry freezes 1,917,477 triangles / 6,435 meshes / 6,570 surfaces / 3,355 unique meshes"
	)
	_check(
	...
	_check(
		...
		"loaded geometry freezes 2,051,611 triangles / 6,644 meshes / 6,779 surfaces / 3,495 unique meshes"
	)
	_check(
