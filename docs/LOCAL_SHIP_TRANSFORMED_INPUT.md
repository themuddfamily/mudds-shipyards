...
nothing. No GameFlow change is required to use this API, and this slice does not
claim startup wiring.
...
HeroShip, AI, or device-selection policy. Startup remains responsible for passing
the active RuntimeSettings profile and later replacements into this explicit API.
