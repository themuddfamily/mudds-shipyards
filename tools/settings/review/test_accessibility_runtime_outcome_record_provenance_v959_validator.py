...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v959_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v959",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV959Tests(unittest.TestCase):
