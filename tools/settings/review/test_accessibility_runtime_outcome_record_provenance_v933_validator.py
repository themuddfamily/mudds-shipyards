...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v933_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v933",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV933Tests(unittest.TestCase):
