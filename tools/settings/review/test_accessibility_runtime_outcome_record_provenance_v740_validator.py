...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v740_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v740",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV740Tests(unittest.TestCase):
