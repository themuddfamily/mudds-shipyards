...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v677_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v677",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV677Tests(unittest.TestCase):
