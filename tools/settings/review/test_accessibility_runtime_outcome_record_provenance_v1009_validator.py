...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1009_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1009",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1009Tests(unittest.TestCase):
