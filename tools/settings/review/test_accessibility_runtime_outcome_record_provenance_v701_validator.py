...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v701_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v701",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV701Tests(unittest.TestCase):
