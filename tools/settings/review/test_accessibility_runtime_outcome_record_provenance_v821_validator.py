...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v821_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v821",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV821Tests(unittest.TestCase):
