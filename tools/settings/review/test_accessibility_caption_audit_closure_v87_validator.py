...
from tools.settings.review.accessibility_caption_audit_closure_v87_validator import (
    AUDIT_CHECKS,
    AUDIT_CLOSURE,
    AUDIT_ID,
    AUTHORITY,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-audit-v87",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v87 audit/closure review or native render has been performed",
...
class AccessibilityCaptionAuditClosureV87Tests(unittest.TestCase):
    ...
    def test_v86_source_chain_is_exact(self):
        value = _record()
        value["source_schema"] = "accessibility_caption_verification_lineage_v85_evidence_v1"
        value["source_verification_id"] = "caption-accessibility-verification-v85"
        value["audit_closure"]["previous_version"] = "v85"
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v87.json", "sha256": "bad"}]
        errors = validate_audit_closure(value)
