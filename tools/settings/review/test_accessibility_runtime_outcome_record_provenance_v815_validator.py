...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v815_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v815",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV815Tests(unittest.TestCase):
