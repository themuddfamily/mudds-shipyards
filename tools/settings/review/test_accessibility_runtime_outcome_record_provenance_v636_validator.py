...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v636_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v636",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV636Tests(unittest.TestCase):
