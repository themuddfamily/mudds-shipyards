...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v664_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v664",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV664Tests(unittest.TestCase):
