...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v569_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v569",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV569Tests(unittest.TestCase):
