...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v730_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v730",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV730Tests(unittest.TestCase):
