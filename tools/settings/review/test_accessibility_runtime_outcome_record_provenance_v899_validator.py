...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v899_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v899",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV899Tests(unittest.TestCase):
