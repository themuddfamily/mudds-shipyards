...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v838_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v838",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV838Tests(unittest.TestCase):
