...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v718_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v718",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV718Tests(unittest.TestCase):
