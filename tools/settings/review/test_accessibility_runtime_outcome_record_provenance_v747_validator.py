...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v747_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v747",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV747Tests(unittest.TestCase):
