...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v945_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v945",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV945Tests(unittest.TestCase):
