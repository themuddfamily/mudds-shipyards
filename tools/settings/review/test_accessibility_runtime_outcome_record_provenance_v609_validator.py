...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v609_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v609",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV609Tests(unittest.TestCase):
