...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v912_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v912",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV912Tests(unittest.TestCase):
