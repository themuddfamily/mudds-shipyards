...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v623_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v623",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV623Tests(unittest.TestCase):
