...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v860_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v860",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV860Tests(unittest.TestCase):
