...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v653_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v653",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV653Tests(unittest.TestCase):
