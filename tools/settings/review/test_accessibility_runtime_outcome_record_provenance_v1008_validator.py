...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1008_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1008",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1008Tests(unittest.TestCase):
