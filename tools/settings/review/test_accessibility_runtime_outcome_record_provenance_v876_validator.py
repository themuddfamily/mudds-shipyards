...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v876_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v876",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV876Tests(unittest.TestCase):
