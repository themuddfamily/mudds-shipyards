...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v733_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v733",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV733Tests(unittest.TestCase):
