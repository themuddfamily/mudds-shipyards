...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v852_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v852",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV852Tests(unittest.TestCase):
