...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v782_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v782",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV782Tests(unittest.TestCase):
