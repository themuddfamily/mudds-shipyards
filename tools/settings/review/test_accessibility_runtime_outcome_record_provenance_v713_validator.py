...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v713_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v713",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV713Tests(unittest.TestCase):
