...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v728_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v728",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV728Tests(unittest.TestCase):
