...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v746_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v746",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV746Tests(unittest.TestCase):
