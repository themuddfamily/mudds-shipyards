...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v984_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v984",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV984Tests(unittest.TestCase):
