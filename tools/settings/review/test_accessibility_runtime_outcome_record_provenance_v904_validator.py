...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v904_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v904",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV904Tests(unittest.TestCase):
