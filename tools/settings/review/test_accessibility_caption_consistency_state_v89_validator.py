...
from tools.settings.review.accessibility_caption_consistency_state_v89_validator import (
    AUTHORITY,
    BINDING,
    CONSISTENCY_CHECKS,
    CONSISTENCY_ID,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-consistency-v89",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v89 consistency/state review or native render has been performed",
...
class AccessibilityCaptionConsistencyStateV89Tests(unittest.TestCase):
    ...
    def test_v88_source_chain_is_exact(self):
        value = _record()
        value["source_schema"] = "accessibility_caption_provenance_closure_v87_evidence_v1"
        value["source_provenance_id"] = "caption-accessibility-provenance-v87"
        value["consistency_state"]["previous_version"] = "v87"
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v89.json", "sha256": "bad"}]
        errors = validate_consistency_state(value)
