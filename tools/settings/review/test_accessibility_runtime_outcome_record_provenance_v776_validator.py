...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v776_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v776",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV776Tests(unittest.TestCase):
