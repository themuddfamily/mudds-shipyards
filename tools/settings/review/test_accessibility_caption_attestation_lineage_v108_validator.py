...
from tools.settings.review.accessibility_caption_attestation_lineage_v108_validator import (
    ATTESTATION_CHECKS,
    ATTESTATION_ID,
    ATTESTATION_LINEAGE,
    AUTHORITY,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-attestation-lineage-v108",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v108 attestation/lineage review or native render has been performed",
...
class AccessibilityCaptionAttestationLineageV108Tests(unittest.TestCase):
    ...
    def test_v107_source_chain_is_exact(self):
        value = _record()
        value["source_schema"] = "accessibility_caption_consistency_state_v106_evidence_v1"
        value["source_consistency_id"] = "caption-accessibility-consistency-v106"
        value["attestation_lineage"]["previous_version"] = "v106"
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v108.json", "sha256": "bad"}]
        errors = validate_attestation_lineage(value)
