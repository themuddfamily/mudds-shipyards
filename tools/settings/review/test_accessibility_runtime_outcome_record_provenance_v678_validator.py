...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v678_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v678",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV678Tests(unittest.TestCase):
