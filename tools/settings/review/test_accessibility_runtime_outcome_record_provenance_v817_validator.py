...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v817_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v817",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV817Tests(unittest.TestCase):
