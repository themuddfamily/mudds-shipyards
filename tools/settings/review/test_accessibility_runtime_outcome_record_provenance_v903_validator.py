...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v903_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v903",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV903Tests(unittest.TestCase):
