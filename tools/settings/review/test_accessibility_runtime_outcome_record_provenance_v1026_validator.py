...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1026_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1026",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1026Tests(unittest.TestCase):
