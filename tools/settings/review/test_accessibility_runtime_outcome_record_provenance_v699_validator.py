...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v699_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v699",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV699Tests(unittest.TestCase):
