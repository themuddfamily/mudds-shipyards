...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v595_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v595",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV595Tests(unittest.TestCase):
