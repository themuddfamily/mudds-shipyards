...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v792_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v792",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV792Tests(unittest.TestCase):
