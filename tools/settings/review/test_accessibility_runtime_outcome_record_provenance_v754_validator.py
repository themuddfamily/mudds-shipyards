...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v754_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v754",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV754Tests(unittest.TestCase):
