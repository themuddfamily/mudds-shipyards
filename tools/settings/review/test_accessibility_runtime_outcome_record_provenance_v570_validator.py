...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v570_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v570",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV570Tests(unittest.TestCase):
