...
from tools.settings.review.accessibility_caption_release_version_reconciliation_v54_validator import (
    AUTHORITY,
    BINDING,
    PREVIOUS_VERSION,
    RELEASE_ID,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-release-reconciliation-v54",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v54 release/reconciliation review or native render has been performed",
...
class AccessibilityCaptionReleaseVersionReconciliationV54Tests(unittest.TestCase):
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v54.json", "sha256": "bad"}]
        errors = validate_release_version_reconciliation(value)
