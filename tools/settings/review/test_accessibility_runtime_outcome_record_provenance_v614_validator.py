...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v614_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v614",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV614Tests(unittest.TestCase):
