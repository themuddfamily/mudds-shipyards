...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v978_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v978",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV978Tests(unittest.TestCase):
