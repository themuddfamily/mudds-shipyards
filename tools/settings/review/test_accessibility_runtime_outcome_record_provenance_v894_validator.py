...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v894_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v894",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV894Tests(unittest.TestCase):
