...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v779_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v779",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV779Tests(unittest.TestCase):
