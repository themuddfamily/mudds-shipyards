...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v811_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v811",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV811Tests(unittest.TestCase):
