...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v693_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v693",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV693Tests(unittest.TestCase):
