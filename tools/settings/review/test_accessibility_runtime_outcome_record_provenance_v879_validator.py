...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v879_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v879",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV879Tests(unittest.TestCase):
