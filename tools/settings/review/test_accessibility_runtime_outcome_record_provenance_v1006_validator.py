...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1006_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1006",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1006Tests(unittest.TestCase):
