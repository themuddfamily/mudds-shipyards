...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v868_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v868",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV868Tests(unittest.TestCase):
