...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1016_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1016",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1016Tests(unittest.TestCase):
