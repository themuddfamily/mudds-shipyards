...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v264_validator import (
...
def _record() -> dict:
    return {"schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": SCHEMA_VERSION,
            "source_revision": "working-tree-runtime-outcome-record-v264",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV264Tests(unittest.TestCase):
