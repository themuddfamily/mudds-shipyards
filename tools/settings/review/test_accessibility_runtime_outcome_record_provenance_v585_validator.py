...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v585_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v585",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV585Tests(unittest.TestCase):
