...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v721_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v721",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV721Tests(unittest.TestCase):
