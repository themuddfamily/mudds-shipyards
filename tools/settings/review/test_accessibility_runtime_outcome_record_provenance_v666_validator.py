...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v666_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v666",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV666Tests(unittest.TestCase):
