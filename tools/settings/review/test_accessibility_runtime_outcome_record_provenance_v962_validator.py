...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v962_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v962",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV962Tests(unittest.TestCase):
