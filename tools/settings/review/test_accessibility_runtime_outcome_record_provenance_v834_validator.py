...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v834_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v834",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV834Tests(unittest.TestCase):
