...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v641_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v641",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV641Tests(unittest.TestCase):
