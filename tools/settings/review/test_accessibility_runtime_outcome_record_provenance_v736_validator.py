...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v736_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v736",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV736Tests(unittest.TestCase):
