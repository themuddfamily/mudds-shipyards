...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1002_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1002",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1002Tests(unittest.TestCase):
