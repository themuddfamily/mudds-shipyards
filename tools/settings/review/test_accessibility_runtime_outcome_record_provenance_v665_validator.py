...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v665_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v665",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV665Tests(unittest.TestCase):
