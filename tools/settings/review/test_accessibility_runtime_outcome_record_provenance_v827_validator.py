...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v827_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v827",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV827Tests(unittest.TestCase):
