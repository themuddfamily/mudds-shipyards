...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v980_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v980",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV980Tests(unittest.TestCase):
