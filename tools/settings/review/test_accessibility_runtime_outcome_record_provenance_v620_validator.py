...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v620_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v620",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV620Tests(unittest.TestCase):
