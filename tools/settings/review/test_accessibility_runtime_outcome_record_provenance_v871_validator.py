...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v871_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v871",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV871Tests(unittest.TestCase):
