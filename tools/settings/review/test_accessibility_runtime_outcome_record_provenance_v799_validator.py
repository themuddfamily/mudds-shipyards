...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v799_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v799",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV799Tests(unittest.TestCase):
