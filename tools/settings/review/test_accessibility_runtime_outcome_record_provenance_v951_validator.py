...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v951_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v951",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV951Tests(unittest.TestCase):
