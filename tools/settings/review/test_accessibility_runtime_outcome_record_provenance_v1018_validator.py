...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1018_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1018",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1018Tests(unittest.TestCase):
