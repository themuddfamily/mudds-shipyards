...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v963_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v963",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV963Tests(unittest.TestCase):
