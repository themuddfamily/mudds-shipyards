...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v584_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v584",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV584Tests(unittest.TestCase):
