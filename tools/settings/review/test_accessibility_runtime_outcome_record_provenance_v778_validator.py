...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v778_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v778",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV778Tests(unittest.TestCase):
