...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v787_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v787",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV787Tests(unittest.TestCase):
