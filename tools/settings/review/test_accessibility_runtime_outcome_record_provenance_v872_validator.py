...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v872_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v872",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV872Tests(unittest.TestCase):
