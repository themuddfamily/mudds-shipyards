...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v957_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v957",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV957Tests(unittest.TestCase):
