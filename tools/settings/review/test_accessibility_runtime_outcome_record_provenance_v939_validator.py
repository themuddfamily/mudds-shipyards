...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v939_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v939",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV939Tests(unittest.TestCase):
