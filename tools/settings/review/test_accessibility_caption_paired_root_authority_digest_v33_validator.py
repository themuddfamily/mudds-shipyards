...
from tools.settings.review.accessibility_caption_paired_root_authority_digest_v33_validator import (
    AUTHORITY,
    BINDING,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-root-authority-digest-v33",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v33 root/authority digest review or native render has been performed",
...
class AccessibilityCaptionPairedRootAuthorityDigestV33Tests(unittest.TestCase):
    ...
    def test_digests_and_evidence_require_sha256_metadata(self):
        ...
        value["evidence"] = [{"kind": "report", "path": "reports/v33.json", "sha256": "bad"}]
        errors = validate_root_authority_digest(value)
