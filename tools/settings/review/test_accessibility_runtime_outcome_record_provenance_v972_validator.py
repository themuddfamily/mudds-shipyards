...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v972_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v972",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV972Tests(unittest.TestCase):
