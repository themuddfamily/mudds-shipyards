...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v611_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v611",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV611Tests(unittest.TestCase):
