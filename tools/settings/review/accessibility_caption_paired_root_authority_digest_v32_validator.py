#!/usr/bin/env python3
"""Validate v32 paired root/authority digest evidence for captions."""
...
SOURCE_SCHEMA = "accessibility_caption_paired_root_authority_v31_evidence_v1"
...
def validate_root_authority_digest(value: Any) -> list[str]:
    """Return root/digest violations without raising on malformed shapes."""
    ...
    for key in (
        ...
        "root_authority_digest_verified",
        "digest_verified",
...
def main(argv: list[str] | None = None) -> int:
    ...
    if errors:
        print("ACCESSIBILITY_CAPTION_PAIRED_ROOT_AUTHORITY_DIGEST_V32_INVALID")
        print("\n".join(f"- {error}" for error in errors))
        return 1
    print("ACCESSIBILITY_CAPTION_PAIRED_ROOT_AUTHORITY_DIGEST_V32_READY: human review remains open")
    return 0
