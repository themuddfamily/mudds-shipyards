...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v632_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v632",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV632Tests(unittest.TestCase):
