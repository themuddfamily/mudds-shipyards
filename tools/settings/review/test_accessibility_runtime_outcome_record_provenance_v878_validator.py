...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v878_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v878",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV878Tests(unittest.TestCase):
