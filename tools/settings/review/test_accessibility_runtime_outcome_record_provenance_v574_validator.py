...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v574_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v574",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV574Tests(unittest.TestCase):
