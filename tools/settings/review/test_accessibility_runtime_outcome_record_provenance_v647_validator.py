...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v647_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v647",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV647Tests(unittest.TestCase):
