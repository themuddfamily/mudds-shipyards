...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v797_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v797",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV797Tests(unittest.TestCase):
