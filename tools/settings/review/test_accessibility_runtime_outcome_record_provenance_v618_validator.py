...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v618_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v618",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV618Tests(unittest.TestCase):
