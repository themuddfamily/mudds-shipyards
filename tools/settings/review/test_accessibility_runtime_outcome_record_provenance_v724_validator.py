...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v724_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v724",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV724Tests(unittest.TestCase):
