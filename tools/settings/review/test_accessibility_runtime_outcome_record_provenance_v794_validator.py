...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v794_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v794",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV794Tests(unittest.TestCase):
