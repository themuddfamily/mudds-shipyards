...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v940_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v940",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV940Tests(unittest.TestCase):
