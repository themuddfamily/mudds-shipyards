...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v847_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v847",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV847Tests(unittest.TestCase):
