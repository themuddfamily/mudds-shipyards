...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v645_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v645",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV645Tests(unittest.TestCase):
