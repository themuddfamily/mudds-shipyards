...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1001_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1001",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1001Tests(unittest.TestCase):
