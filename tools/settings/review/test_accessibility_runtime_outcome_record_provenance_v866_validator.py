...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v866_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v866",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV866Tests(unittest.TestCase):
