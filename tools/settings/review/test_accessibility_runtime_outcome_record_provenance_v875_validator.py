...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v875_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v875",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV875Tests(unittest.TestCase):
