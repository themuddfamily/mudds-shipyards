...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v631_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v631",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV631Tests(unittest.TestCase):
