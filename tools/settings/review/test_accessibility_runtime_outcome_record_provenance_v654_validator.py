...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v654_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v654",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV654Tests(unittest.TestCase):
