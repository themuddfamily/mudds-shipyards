...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v970_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v970",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV970Tests(unittest.TestCase):
