...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v949_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v949",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV949Tests(unittest.TestCase):
