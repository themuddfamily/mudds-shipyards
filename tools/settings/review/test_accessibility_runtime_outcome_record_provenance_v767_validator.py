...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v767_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v767",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV767Tests(unittest.TestCase):
