...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v759_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v759",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV759Tests(unittest.TestCase):
