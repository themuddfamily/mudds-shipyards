...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v814_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v814",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV814Tests(unittest.TestCase):
