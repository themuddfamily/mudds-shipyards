...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v914_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v914",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV914Tests(unittest.TestCase):
