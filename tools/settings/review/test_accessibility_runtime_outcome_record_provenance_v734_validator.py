...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v734_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v734",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV734Tests(unittest.TestCase):
