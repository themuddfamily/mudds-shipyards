...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1020_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1020",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1020Tests(unittest.TestCase):
