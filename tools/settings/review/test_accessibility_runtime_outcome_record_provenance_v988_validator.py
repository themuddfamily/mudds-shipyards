...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v988_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v988",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV988Tests(unittest.TestCase):
