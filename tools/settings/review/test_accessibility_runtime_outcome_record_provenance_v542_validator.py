...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v542_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v542",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV542Tests(unittest.TestCase):
