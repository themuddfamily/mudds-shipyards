...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v974_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v974",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV974Tests(unittest.TestCase):
