...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v723_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v723",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV723Tests(unittest.TestCase):
