...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v642_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v642",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV642Tests(unittest.TestCase):
