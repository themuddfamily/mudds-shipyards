...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v601_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v601",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV601Tests(unittest.TestCase):
