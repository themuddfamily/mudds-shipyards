...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v785_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v785",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV785Tests(unittest.TestCase):
