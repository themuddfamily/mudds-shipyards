...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v790_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v790",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV790Tests(unittest.TestCase):
