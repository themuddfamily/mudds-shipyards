...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v602_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v602",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV602Tests(unittest.TestCase):
