...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v905_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v905",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV905Tests(unittest.TestCase):
