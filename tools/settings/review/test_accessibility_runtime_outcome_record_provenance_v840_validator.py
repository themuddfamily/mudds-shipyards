...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v840_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v840",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV840Tests(unittest.TestCase):
