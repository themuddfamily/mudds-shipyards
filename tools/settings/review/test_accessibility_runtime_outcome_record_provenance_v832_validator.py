...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v832_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v832",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV832Tests(unittest.TestCase):
