...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v928_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v928",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV928Tests(unittest.TestCase):
