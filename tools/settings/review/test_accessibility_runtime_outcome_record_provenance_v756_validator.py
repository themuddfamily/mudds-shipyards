...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v756_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v756",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV756Tests(unittest.TestCase):
