...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v812_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v812",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV812Tests(unittest.TestCase):
