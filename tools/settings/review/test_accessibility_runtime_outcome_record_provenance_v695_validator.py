...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v695_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v695",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV695Tests(unittest.TestCase):
