...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1022_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1022",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1022Tests(unittest.TestCase):
