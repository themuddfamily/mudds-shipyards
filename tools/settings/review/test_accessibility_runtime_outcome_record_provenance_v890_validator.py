...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v890_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v890",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV890Tests(unittest.TestCase):
