...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v546_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v546",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV546Tests(unittest.TestCase):
