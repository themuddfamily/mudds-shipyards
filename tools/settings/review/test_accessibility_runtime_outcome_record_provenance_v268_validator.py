...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v268_validator import AUTHORITY,BINDING,CONTRACT_ID,OUTCOME_POLICY,SCHEMA,SCHEMA_VERSION,SOURCE_ID,SOURCE_SCHEMA,validate_runtime_outcome_record_provenance
def _record()->dict:return {"schema":SCHEMA,"source_schema":SOURCE_SCHEMA,"schema_version":SCHEMA_VERSION,"source_revision":"working-tree-runtime-outcome-record-v268","reviewer_required":"human accessibility and outcome-record QA","open_gate_reason":"human and native outcome validation have not been performed","human_review_status":"not_performed","native_render_status":"not_run","human_review_performed":False,"native_render_performed":False,"policy_verified":False,"runtime_claimed":False,"outcome_written":False,"outcome_confirmed":False,"outcome_policy":copy.deepcopy(OUTCOME_POLICY),"binding":copy.deepcopy(BINDING),"authority":copy.deepcopy(AUTHORITY),"source_id":SOURCE_ID,"contract_id":CONTRACT_ID,"provenance_source_of_truth":"runtime_accessibility_outcome_record_policy","status":"planned","evidence":None,**AUTHORITY}
class AccessibilityRuntimeOutcomeRecordProvenanceV268Tests(unittest.TestCase):
