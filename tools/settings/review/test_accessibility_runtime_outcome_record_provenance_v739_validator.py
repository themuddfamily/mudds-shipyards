...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v739_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v739",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV739Tests(unittest.TestCase):
