...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v561_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v561",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV561Tests(unittest.TestCase):
