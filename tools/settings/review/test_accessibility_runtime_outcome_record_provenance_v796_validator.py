...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v796_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v796",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV796Tests(unittest.TestCase):
