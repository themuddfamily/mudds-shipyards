...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v562_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v562",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV562Tests(unittest.TestCase):
