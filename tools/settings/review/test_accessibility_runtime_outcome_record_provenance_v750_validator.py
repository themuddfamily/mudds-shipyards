...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v750_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v750",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV750Tests(unittest.TestCase):
