...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v774_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v774",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV774Tests(unittest.TestCase):
