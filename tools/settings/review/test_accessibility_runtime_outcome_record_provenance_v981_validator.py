...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v981_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v981",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV981Tests(unittest.TestCase):
