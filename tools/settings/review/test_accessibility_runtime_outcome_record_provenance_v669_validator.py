...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v669_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v669",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV669Tests(unittest.TestCase):
