...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v865_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v865",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV865Tests(unittest.TestCase):
