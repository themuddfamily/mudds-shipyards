#!/usr/bin/env python3
"""Validate v51 versioned authority/reconciliation evidence."""
...
SOURCE_SCHEMA = "accessibility_caption_versioned_authority_reconciliation_v50_evidence_v1"
SCHEMA_VERSION = "v51"
PREVIOUS_VERSION = "v50"
...
def validate_versioned_authority_reconciliation(value: Any) -> list[str]:
    ...
    if value.get("versioned_authority_reconciliation") != VERSIONED_AUTHORITY_RECONCILIATION:
        errors.append("versioned_authority_reconciliation must exactly match v51 versions, authority, reconciliation, and stale policy")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if errors:
        print("ACCESSIBILITY_CAPTION_VERSIONED_AUTHORITY_RECONCILIATION_V51_INVALID")
        print("\n".join(f"- {error}" for error in errors))
        return 1
    print("ACCESSIBILITY_CAPTION_VERSIONED_AUTHORITY_RECONCILIATION_V51_READY: human review remains open")
    return 0
