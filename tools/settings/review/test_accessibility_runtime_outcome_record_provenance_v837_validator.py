...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v837_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v837",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV837Tests(unittest.TestCase):
