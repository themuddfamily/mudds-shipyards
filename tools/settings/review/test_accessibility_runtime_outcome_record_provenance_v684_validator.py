...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v684_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v684",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV684Tests(unittest.TestCase):
