...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v652_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v652",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV652Tests(unittest.TestCase):
