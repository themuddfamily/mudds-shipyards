...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v592_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v592",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV592Tests(unittest.TestCase):
