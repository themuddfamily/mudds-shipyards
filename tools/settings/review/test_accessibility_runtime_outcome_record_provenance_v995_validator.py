...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v995_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v995",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV995Tests(unittest.TestCase):
