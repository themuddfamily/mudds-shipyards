...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v737_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v737",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV737Tests(unittest.TestCase):
