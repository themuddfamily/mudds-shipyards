...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v616_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v616",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV616Tests(unittest.TestCase):
