...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v922_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v922",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV922Tests(unittest.TestCase):
