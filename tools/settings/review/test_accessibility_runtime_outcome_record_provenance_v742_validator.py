...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v742_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v742",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV742Tests(unittest.TestCase):
