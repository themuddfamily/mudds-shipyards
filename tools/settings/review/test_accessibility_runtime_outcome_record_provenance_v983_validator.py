...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v983_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v983",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV983Tests(unittest.TestCase):
