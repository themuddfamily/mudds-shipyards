...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v709_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v709",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV709Tests(unittest.TestCase):
