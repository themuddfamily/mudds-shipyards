...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v916_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v916",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV916Tests(unittest.TestCase):
