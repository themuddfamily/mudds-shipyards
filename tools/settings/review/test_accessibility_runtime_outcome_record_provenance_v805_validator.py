...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v805_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v805",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV805Tests(unittest.TestCase):
