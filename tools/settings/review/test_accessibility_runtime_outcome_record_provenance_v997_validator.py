...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v997_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v997",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV997Tests(unittest.TestCase):
