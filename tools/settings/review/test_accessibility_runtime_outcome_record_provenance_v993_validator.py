...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v993_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v993",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV993Tests(unittest.TestCase):
