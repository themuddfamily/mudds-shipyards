...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v873_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v873",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV873Tests(unittest.TestCase):
