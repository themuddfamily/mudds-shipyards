...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v668_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v668",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV668Tests(unittest.TestCase):
