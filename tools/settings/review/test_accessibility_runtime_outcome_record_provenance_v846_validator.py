...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v846_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v846",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV846Tests(unittest.TestCase):
