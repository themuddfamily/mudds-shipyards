...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v707_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v707",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV707Tests(unittest.TestCase):
