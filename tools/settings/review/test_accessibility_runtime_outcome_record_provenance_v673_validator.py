...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v673_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v673",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV673Tests(unittest.TestCase):
