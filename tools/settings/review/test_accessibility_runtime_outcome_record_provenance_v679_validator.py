...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v679_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v679",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV679Tests(unittest.TestCase):
