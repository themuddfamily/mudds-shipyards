...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v855_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v855",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV855Tests(unittest.TestCase):
