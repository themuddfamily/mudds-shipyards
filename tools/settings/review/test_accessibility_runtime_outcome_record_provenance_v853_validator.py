...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v853_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v853",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV853Tests(unittest.TestCase):
