...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v943_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v943",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV943Tests(unittest.TestCase):
