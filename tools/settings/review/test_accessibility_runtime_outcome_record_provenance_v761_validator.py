...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v761_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v761",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV761Tests(unittest.TestCase):
