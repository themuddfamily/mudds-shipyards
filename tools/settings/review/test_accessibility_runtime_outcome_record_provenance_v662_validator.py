...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v662_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v662",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV662Tests(unittest.TestCase):
