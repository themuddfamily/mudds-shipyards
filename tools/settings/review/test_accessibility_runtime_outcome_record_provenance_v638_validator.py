...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v638_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v638",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV638Tests(unittest.TestCase):
