...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v655_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v655",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV655Tests(unittest.TestCase):
