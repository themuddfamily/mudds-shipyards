...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v921_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v921",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV921Tests(unittest.TestCase):
