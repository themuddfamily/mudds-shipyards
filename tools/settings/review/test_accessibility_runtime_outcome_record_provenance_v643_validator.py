...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v643_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v643",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV643Tests(unittest.TestCase):
