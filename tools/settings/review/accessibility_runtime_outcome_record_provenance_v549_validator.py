"""Validate v549 accessibility runtime outcome provenance."""
...
SCHEMA = "accessibility_runtime_outcome_record_provenance_v549_evidence_v1"
...
def validate_runtime_outcome_record_provenance(value):
    ...
    if value.get("schema_version") != "v549":
