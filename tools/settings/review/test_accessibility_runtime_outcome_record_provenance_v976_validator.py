...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v976_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v976",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV976Tests(unittest.TestCase):
