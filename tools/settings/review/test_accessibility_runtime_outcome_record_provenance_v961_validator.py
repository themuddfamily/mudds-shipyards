...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v961_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v961",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV961Tests(unittest.TestCase):
