...
from tools.settings.review.accessibility_caption_evidence_state_v95_validator import (
    AUTHORITY,
    BINDING,
    CONTRACT_ID,
    EVIDENCE_CHECKS,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-evidence-state-v95",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v95 evidence/state review or native render has been performed",
...
class AccessibilityCaptionEvidenceStateV95Tests(unittest.TestCase):
    ...
    def test_v94_source_chain_is_exact(self):
        value = _record()
        value["source_schema"] = "accessibility_caption_audit_lineage_v93_evidence_v1"
        value["source_audit_id"] = "caption-accessibility-audit-v93"
        value["evidence_state"]["previous_version"] = "v93"
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v95.json", "sha256": "bad"}]
        errors = validate_evidence_state(value)
