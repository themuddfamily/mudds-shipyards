...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v897_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v897",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV897Tests(unittest.TestCase):
