...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v911_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v911",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV911Tests(unittest.TestCase):
