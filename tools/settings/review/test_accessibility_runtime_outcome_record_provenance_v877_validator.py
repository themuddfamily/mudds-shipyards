...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v877_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v877",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV877Tests(unittest.TestCase):
