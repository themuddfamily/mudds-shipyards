...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v965_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v965",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV965Tests(unittest.TestCase):
