...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v944_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v944",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV944Tests(unittest.TestCase):
