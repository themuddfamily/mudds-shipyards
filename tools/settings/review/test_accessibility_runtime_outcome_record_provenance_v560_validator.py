...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v560_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v560",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV560Tests(unittest.TestCase):
