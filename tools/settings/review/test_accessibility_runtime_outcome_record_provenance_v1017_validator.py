...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1017_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1017",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1017Tests(unittest.TestCase):
