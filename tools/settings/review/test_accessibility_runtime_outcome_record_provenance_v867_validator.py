...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v867_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v867",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV867Tests(unittest.TestCase):
