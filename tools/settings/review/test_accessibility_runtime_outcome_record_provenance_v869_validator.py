...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v869_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v869",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV869Tests(unittest.TestCase):
