...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v690_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v690",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV690Tests(unittest.TestCase):
