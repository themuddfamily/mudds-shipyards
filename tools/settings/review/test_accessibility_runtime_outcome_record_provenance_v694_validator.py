...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v694_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v694",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV694Tests(unittest.TestCase):
