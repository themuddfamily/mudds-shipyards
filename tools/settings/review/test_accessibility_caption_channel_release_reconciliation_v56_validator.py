...
from tools.settings.review.accessibility_caption_channel_release_reconciliation_v56_validator import (
    AUTHORITY,
    BINDING,
    CHANNEL_ID,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-channel-release-v56",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v56 channel/release review or native render has been performed",
...
class AccessibilityCaptionChannelReleaseReconciliationV56Tests(unittest.TestCase):
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v56.json", "sha256": "bad"}]
        errors = validate_channel_release_reconciliation(value)
