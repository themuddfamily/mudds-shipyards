...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v735_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v735",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV735Tests(unittest.TestCase):
