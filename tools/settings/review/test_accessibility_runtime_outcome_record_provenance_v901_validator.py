...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v901_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v901",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV901Tests(unittest.TestCase):
