...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v720_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v720",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV720Tests(unittest.TestCase):
