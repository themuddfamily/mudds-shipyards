...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v947_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v947",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV947Tests(unittest.TestCase):
