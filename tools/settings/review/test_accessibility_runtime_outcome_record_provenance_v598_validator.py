...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v598_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v598",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV598Tests(unittest.TestCase):
