...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v892_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v892",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV892Tests(unittest.TestCase):
