...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v594_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v594",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV594Tests(unittest.TestCase):
