...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v772_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v772",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV772Tests(unittest.TestCase):
