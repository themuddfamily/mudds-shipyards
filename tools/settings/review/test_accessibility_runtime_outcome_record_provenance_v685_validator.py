...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v685_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v685",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV685Tests(unittest.TestCase):
