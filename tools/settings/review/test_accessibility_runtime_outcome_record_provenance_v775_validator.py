...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v775_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v775",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV775Tests(unittest.TestCase):
