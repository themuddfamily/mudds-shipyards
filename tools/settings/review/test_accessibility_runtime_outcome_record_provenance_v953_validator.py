...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v953_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v953",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV953Tests(unittest.TestCase):
