...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v610_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v610",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV610Tests(unittest.TestCase):
