...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v651_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v651",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV651Tests(unittest.TestCase):
