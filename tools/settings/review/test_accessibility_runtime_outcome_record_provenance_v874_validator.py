...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v874_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v874",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV874Tests(unittest.TestCase):
