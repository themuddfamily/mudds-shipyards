...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v583_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v583",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV583Tests(unittest.TestCase):
