...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v850_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v850",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV850Tests(unittest.TestCase):
