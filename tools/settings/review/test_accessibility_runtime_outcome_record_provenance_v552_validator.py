...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v552_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v552",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV552Tests(unittest.TestCase):
