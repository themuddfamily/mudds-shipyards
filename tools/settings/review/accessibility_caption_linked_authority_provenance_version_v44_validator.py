#!/usr/bin/env python3
"""Validate v44 linked authority/provenance/version evidence."""
...
SOURCE_SCHEMA = "accessibility_caption_linked_authority_provenance_version_v43_evidence_v1"
SCHEMA_VERSION = "v44"
...
def validate_linked_authority_provenance_version(value: Any) -> list[str]:
    ...
    if value.get("linked_authority_provenance_version") != LINKED_AUTHORITY_PROVENANCE_VERSION:
        errors.append("linked_authority_provenance_version must exactly match v44 linkage, version, and stale policy")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if errors:
        print("ACCESSIBILITY_CAPTION_LINKED_AUTHORITY_PROVENANCE_VERSION_V44_INVALID")
        print("\n".join(f"- {error}" for error in errors))
        return 1
    print("ACCESSIBILITY_CAPTION_LINKED_AUTHORITY_PROVENANCE_VERSION_V44_READY: human review remains open")
    return 0
