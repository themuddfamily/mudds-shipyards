...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v580_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v580",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV580Tests(unittest.TestCase):
