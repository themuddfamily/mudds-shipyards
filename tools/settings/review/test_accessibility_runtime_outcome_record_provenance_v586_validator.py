...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v586_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v586",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV586Tests(unittest.TestCase):
