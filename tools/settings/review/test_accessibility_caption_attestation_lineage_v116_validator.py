...
from tools.settings.review.accessibility_caption_attestation_lineage_v116_validator import (
    ATTESTATION_CHECKS,
    ATTESTATION_ID,
    ATTESTATION_LINEAGE,
    AUTHORITY,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-attestation-lineage-v116",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v116 attestation/lineage review or native render has been performed",
...
class AccessibilityCaptionAttestationLineageV116Tests(unittest.TestCase):
    ...
    def test_v115_source_chain_is_exact(self):
        value = _record()
        value["source_schema"] = "accessibility_caption_audit_state_v114_evidence_v1"
        value["source_audit_id"] = "caption-accessibility-audit-v114"
        value["attestation_lineage"]["previous_version"] = "v114"
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v116.json", "sha256": "bad"}]
        errors = validate_attestation_lineage(value)
