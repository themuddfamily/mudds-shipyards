...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v996_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v996",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV996Tests(unittest.TestCase):
