...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v881_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v881",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV881Tests(unittest.TestCase):
