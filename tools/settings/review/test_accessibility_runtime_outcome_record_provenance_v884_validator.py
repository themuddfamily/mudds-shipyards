...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v884_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v884",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV884Tests(unittest.TestCase):
