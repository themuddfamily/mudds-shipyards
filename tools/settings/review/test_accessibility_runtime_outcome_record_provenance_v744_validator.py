...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v744_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v744",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV744Tests(unittest.TestCase):
