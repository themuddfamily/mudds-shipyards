...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v863_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v863",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV863Tests(unittest.TestCase):
