...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v605_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v605",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV605Tests(unittest.TestCase):
