...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v937_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v937",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV937Tests(unittest.TestCase):
