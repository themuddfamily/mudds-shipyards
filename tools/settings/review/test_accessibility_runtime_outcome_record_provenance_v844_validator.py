...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v844_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v844",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV844Tests(unittest.TestCase):
