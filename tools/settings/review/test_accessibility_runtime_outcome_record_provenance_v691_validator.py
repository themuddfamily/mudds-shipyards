...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v691_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v691",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV691Tests(unittest.TestCase):
