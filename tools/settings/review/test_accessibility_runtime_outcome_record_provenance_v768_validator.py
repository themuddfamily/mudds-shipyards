...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v768_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v768",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV768Tests(unittest.TestCase):
