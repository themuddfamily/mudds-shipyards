...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v769_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v769",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV769Tests(unittest.TestCase):
