...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v859_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v859",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV859Tests(unittest.TestCase):
