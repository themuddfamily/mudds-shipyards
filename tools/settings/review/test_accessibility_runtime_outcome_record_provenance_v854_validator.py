...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v854_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v854",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV854Tests(unittest.TestCase):
