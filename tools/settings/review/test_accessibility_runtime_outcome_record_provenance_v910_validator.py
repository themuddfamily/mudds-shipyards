...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v910_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v910",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV910Tests(unittest.TestCase):
