...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v886_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v886",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV886Tests(unittest.TestCase):
