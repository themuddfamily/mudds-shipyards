...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v784_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v784",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV784Tests(unittest.TestCase):
