...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v800_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v800",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV800Tests(unittest.TestCase):
