...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v985_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v985",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV985Tests(unittest.TestCase):
