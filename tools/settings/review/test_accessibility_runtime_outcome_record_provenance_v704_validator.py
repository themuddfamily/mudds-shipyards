...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v704_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v704",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV704Tests(unittest.TestCase):
