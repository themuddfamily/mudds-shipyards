...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v715_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v715",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV715Tests(unittest.TestCase):
