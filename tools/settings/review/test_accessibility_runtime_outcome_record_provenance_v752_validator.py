...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v752_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v752",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV752Tests(unittest.TestCase):
