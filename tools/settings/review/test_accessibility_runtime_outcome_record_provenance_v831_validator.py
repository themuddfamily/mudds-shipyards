...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v831_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v831",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV831Tests(unittest.TestCase):
