...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1007_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1007",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1007Tests(unittest.TestCase):
