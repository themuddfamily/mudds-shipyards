...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v801_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v801",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV801Tests(unittest.TestCase):
