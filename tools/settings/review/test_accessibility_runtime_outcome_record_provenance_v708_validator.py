...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v708_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v708",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV708Tests(unittest.TestCase):
