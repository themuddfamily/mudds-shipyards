...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1015_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1015",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1015Tests(unittest.TestCase):
