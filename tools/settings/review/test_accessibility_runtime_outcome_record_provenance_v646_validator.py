...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v646_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v646",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV646Tests(unittest.TestCase):
