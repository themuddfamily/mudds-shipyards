...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v764_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v764",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV764Tests(unittest.TestCase):
