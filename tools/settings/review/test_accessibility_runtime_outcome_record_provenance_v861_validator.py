...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v861_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v861",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV861Tests(unittest.TestCase):
