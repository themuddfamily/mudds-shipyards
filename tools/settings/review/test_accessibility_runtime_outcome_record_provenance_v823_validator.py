...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v823_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v823",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV823Tests(unittest.TestCase):
