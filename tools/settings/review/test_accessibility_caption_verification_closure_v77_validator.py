...
from tools.settings.review.accessibility_caption_verification_closure_v77_validator import (
    AUTHORITY,
    BINDING,
    CONTRACT_ID,
    PREVIOUS_VERSION,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-verification-v77",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v77 verification/closure review or native render has been performed",
...
class AccessibilityCaptionVerificationClosureV77Tests(unittest.TestCase):
    ...
    def test_v76_source_chain_is_exact(self):
        value = _record()
        value["source_schema"] = "accessibility_caption_attestation_lineage_v75_evidence_v1"
        value["source_attestation_id"] = "caption-accessibility-attestation-v75"
        value["verification_closure"]["previous_version"] = "v75"
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v77.json", "sha256": "bad"}]
        errors = validate_verification_closure(value)
