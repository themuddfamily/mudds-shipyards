...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v553_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v553",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV553Tests(unittest.TestCase):
