...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v582_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v582",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV582Tests(unittest.TestCase):
