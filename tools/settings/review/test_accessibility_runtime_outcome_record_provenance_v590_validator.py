...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v590_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v590",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV590Tests(unittest.TestCase):
