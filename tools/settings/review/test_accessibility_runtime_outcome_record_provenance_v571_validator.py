...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v571_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v571",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV571Tests(unittest.TestCase):
