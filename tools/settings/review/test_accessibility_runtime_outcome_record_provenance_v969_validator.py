...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v969_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v969",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV969Tests(unittest.TestCase):
