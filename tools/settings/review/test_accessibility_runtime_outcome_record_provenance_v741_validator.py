...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v741_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v741",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV741Tests(unittest.TestCase):
