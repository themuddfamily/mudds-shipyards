...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v650_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v650",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV650Tests(unittest.TestCase):
