...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v819_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v819",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV819Tests(unittest.TestCase):
