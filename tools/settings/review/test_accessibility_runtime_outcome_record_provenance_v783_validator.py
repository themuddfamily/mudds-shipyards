...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v783_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v783",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV783Tests(unittest.TestCase):
