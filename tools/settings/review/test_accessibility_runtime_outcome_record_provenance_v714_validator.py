...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v714_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v714",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV714Tests(unittest.TestCase):
