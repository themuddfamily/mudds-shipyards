...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v729_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v729",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV729Tests(unittest.TestCase):
