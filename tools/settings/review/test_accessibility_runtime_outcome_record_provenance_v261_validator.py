...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v261_validator import (
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-runtime-outcome-record-v261",
        "reviewer_required": "human accessibility and outcome-record QA",
        "open_gate_reason": "no human outcome review or native render has been performed",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV261Tests(unittest.TestCase):
    ...
    def test_outcome_accessibility_fields_cannot_shrink(self):
    ...
    def test_native_and_outcome_claims_must_remain_open(self):
