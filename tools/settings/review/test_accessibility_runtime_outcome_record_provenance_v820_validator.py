...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v820_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v820",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV820Tests(unittest.TestCase):
