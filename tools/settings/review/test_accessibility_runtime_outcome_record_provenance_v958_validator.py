...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v958_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v958",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV958Tests(unittest.TestCase):
