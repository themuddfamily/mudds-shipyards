...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v950_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v950",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV950Tests(unittest.TestCase):
