...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v979_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v979",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV979Tests(unittest.TestCase):
