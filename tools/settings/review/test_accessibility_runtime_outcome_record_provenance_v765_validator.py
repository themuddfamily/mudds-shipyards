...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v765_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v765",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV765Tests(unittest.TestCase):
