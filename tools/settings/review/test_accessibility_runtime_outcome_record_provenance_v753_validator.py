...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v753_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v753",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV753Tests(unittest.TestCase):
