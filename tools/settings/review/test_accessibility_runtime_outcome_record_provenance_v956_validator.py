...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v956_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v956",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV956Tests(unittest.TestCase):
