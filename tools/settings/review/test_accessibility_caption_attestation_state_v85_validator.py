...
from tools.settings.review.accessibility_caption_attestation_state_v85_validator import (
    ATTESTATION_CHECKS,
    ATTESTATION_ID,
    ATTESTATION_STATE,
    AUTHORITY,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-attestation-v85",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v85 attestation/state review or native render has been performed",
...
class AccessibilityCaptionAttestationStateV85Tests(unittest.TestCase):
    ...
    def test_v84_source_chain_is_exact(self):
        value = _record()
        value["source_schema"] = "accessibility_caption_source_state_v83_evidence_v1"
        value["source_identity"] = "caption-accessibility-source-v83"
        value["attestation_state"]["previous_version"] = "v83"
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v85.json", "sha256": "bad"}]
        errors = validate_attestation_state(value)
