...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v755_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v755",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV755Tests(unittest.TestCase):
