...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v674_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v674",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV674Tests(unittest.TestCase):
