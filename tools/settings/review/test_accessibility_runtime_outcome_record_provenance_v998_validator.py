...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v998_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v998",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV998Tests(unittest.TestCase):
