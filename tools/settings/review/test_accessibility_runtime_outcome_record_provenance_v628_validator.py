...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v628_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v628",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV628Tests(unittest.TestCase):
