...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v977_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v977",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV977Tests(unittest.TestCase):
