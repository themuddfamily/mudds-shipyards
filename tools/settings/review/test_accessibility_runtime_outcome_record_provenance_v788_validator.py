...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v788_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v788",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV788Tests(unittest.TestCase):
