...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v575_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v575",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV575Tests(unittest.TestCase):
