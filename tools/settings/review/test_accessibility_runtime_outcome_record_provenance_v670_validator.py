...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v670_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v670",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV670Tests(unittest.TestCase):
