...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v986_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v986",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV986Tests(unittest.TestCase):
