...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v702_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v702",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV702Tests(unittest.TestCase):
