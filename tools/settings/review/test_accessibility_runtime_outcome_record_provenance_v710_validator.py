...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v710_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v710",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV710Tests(unittest.TestCase):
