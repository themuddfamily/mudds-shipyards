...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v656_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v656",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV656Tests(unittest.TestCase):
