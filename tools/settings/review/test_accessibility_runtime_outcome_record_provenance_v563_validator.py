...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v563_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v563",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV563Tests(unittest.TestCase):
