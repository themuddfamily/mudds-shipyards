...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v964_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v964",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV964Tests(unittest.TestCase):
