...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v777_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v777",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV777Tests(unittest.TestCase):
