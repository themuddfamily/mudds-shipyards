...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v751_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v751",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV751Tests(unittest.TestCase):
