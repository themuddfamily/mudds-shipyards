...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v588_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v588",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV588Tests(unittest.TestCase):
