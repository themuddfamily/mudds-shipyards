...
from tools.settings.review.accessibility_caption_evidence_closure_v112_validator import (
    AUTHORITY,
    BINDING,
    CONTRACT_ID,
    EVIDENCE_CHECKS,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-evidence-closure-v112",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v112 evidence/closure review or native render has been performed",
...
class AccessibilityCaptionEvidenceClosureV112Tests(unittest.TestCase):
    ...
    def test_v111_source_chain_is_exact(self):
        value = _record()
        value["source_schema"] = "accessibility_caption_consistency_state_v110_evidence_v1"
        value["source_consistency_id"] = "caption-accessibility-consistency-v110"
        value["evidence_closure"]["previous_version"] = "v110"
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v112.json", "sha256": "bad"}]
        errors = validate_evidence_closure(value)
