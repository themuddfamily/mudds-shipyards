...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v600_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v600",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV600Tests(unittest.TestCase):
