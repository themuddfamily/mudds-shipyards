...
from tools.settings.review.accessibility_caption_attestation_state_v93_validator import (
    ATTESTATION_CHECKS,
    ATTESTATION_ID,
    ATTESTATION_STATE,
    AUTHORITY,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-attestation-v93",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v93 attestation/state review or native render has been performed",
...
class AccessibilityCaptionAttestationStateV93Tests(unittest.TestCase):
    ...
    def test_v92_source_chain_is_exact(self):
        value = _record()
        value["source_schema"] = "accessibility_caption_audit_state_v91_evidence_v1"
        value["source_audit_id"] = "caption-accessibility-audit-v91"
        value["attestation_state"]["previous_version"] = "v91"
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v93.json", "sha256": "bad"}]
        errors = validate_attestation_state(value)
