...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v918_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v918",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV918Tests(unittest.TestCase):
