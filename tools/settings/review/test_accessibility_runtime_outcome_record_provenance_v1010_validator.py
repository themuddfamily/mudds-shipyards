...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1010_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1010",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1010Tests(unittest.TestCase):
