...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v902_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v902",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV902Tests(unittest.TestCase):
