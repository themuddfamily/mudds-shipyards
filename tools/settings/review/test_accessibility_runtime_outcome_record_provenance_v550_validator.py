...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v550_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v550",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV550Tests(unittest.TestCase):
