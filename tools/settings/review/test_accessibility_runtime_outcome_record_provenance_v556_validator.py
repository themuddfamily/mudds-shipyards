...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v556_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v556",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV556Tests(unittest.TestCase):
