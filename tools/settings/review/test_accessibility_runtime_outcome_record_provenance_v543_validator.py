...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v543_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v543",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV543Tests(unittest.TestCase):
