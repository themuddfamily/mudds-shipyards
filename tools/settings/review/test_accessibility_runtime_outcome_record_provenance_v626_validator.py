...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v626_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v626",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV626Tests(unittest.TestCase):
