...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v619_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v619",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV619Tests(unittest.TestCase):
