...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v696_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v696",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV696Tests(unittest.TestCase):
