...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v835_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v835",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV835Tests(unittest.TestCase):
