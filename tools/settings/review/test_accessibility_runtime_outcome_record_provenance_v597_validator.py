...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v597_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v597",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV597Tests(unittest.TestCase):
