...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v680_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v680",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV680Tests(unittest.TestCase):
