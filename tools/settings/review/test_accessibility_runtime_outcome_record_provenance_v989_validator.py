...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v989_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v989",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV989Tests(unittest.TestCase):
