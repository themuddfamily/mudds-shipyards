...
from tools.settings.review.accessibility_caption_evidence_closure_v102_validator import (
    AUTHORITY,
    BINDING,
    CONTRACT_ID,
    EVIDENCE_CHECKS,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-evidence-v102",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v102 evidence/closure review or native render has been performed",
...
class AccessibilityCaptionEvidenceClosureV102Tests(unittest.TestCase):
    ...
    def test_v101_source_chain_is_exact(self):
        value = _record()
        value["source_schema"] = "accessibility_caption_audit_lineage_v100_evidence_v1"
        value["source_audit_id"] = "caption-accessibility-audit-v100"
        value["evidence_closure"]["previous_version"] = "v100"
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v102.json", "sha256": "bad"}]
        errors = validate_evidence_closure(value)
