...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v675_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v675",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV675Tests(unittest.TestCase):
