...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v726_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v726",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV726Tests(unittest.TestCase):
