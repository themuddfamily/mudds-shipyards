...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v578_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v578",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV578Tests(unittest.TestCase):
