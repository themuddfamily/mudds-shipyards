...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v537_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v537",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV537Tests(unittest.TestCase):
