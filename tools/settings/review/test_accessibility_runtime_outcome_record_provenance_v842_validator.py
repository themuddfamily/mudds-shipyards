...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v842_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v842",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV842Tests(unittest.TestCase):
