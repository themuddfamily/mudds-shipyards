...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v923_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v923",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV923Tests(unittest.TestCase):
