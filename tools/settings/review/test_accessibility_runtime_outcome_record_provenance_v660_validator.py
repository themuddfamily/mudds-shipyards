...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v660_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v660",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV660Tests(unittest.TestCase):
