...
from tools.settings.review.accessibility_caption_audit_lineage_v94_validator import (
    AUDIT_CHECKS,
    AUDIT_ID,
    AUDIT_LINEAGE,
    AUTHORITY,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-audit-v94",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v94 audit/lineage review or native render has been performed",
...
class AccessibilityCaptionAuditLineageV94Tests(unittest.TestCase):
    ...
    def test_v93_source_chain_is_exact(self):
        value = _record()
        value["source_schema"] = "accessibility_caption_attestation_state_v92_evidence_v1"
        value["source_attestation_id"] = "caption-accessibility-attestation-v92"
        value["audit_lineage"]["previous_version"] = "v92"
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v94.json", "sha256": "bad"}]
        errors = validate_audit_lineage(value)
