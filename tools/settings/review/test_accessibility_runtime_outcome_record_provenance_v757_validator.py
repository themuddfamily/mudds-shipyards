...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v757_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v757",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV757Tests(unittest.TestCase):
