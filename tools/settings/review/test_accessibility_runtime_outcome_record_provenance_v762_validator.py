...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v762_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v762",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV762Tests(unittest.TestCase):
