...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v955_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v955",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV955Tests(unittest.TestCase):
