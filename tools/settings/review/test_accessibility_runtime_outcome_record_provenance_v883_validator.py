...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v883_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v883",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV883Tests(unittest.TestCase):
