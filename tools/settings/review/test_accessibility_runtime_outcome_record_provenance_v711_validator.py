...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v711_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v711",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV711Tests(unittest.TestCase):
