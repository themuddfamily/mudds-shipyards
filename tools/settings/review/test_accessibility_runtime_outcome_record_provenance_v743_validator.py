...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v743_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v743",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV743Tests(unittest.TestCase):
