...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v810_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v810",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV810Tests(unittest.TestCase):
