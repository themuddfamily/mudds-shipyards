...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v688_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v688",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV688Tests(unittest.TestCase):
