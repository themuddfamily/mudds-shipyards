...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v833_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v833",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV833Tests(unittest.TestCase):
