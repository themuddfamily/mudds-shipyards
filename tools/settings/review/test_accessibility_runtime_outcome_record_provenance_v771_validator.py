...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v771_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v771",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV771Tests(unittest.TestCase):
