...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v839_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v839",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV839Tests(unittest.TestCase):
