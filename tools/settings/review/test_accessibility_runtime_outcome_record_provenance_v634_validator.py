...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v634_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v634",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV634Tests(unittest.TestCase):
