...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v579_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v579",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV579Tests(unittest.TestCase):
