...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v689_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v689",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV689Tests(unittest.TestCase):
