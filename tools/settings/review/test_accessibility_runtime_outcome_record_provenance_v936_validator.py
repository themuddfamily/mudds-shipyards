...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v936_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v936",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV936Tests(unittest.TestCase):
