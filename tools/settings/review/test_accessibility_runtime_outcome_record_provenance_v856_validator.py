...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v856_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v856",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV856Tests(unittest.TestCase):
