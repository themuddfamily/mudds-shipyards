...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v591_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v591",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV591Tests(unittest.TestCase):
