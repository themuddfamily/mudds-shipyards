...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v927_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v927",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV927Tests(unittest.TestCase):
