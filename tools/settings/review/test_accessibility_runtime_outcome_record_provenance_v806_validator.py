...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v806_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v806",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV806Tests(unittest.TestCase):
