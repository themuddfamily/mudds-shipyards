...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v999_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v999",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV999Tests(unittest.TestCase):
