...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v566_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v566",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV566Tests(unittest.TestCase):
