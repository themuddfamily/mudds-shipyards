"""Validate v853 accessibility runtime outcome provenance."""
...
SCHEMA = "accessibility_runtime_outcome_record_provenance_v853_evidence_v1"
...
def validate_runtime_outcome_record_provenance(value):
    ...
    if value.get("schema_version") != "v853":
