...
from tools.settings.review.accessibility_caption_manifest_count_digest_authority_v16_validator import (
    AUTHORITY,
    COUNTS,
    DIGEST_INPUTS,
    SOURCE_SCHEMA,
...
def _manifest() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-count-digest-v16",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v16 count/digest review or native render has been performed",
        ...
        "canonicalization": "utf8_json_sorted_keys_no_whitespace_v16",
        "digest_scope": "manifest_count_authority",
        "status": "planned",
        "digest": "0" * 64,
...
class AccessibilityCaptionManifestCountDigestV16Tests(unittest.TestCase):
    ...
    def test_digest_and_evidence_formats_are_validated(self):
        value = _manifest()
        value["digest"] = "bad"
        value["evidence"] = [{"kind": "report", "path": "reports/count-digest-v16.json", "sha256": "bad"}]
        errors = validate_manifest(value)
