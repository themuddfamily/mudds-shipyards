...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v971_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v971",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV971Tests(unittest.TestCase):
