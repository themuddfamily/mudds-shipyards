...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v539_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v539",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV539Tests(unittest.TestCase):
