...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v607_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v607",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV607Tests(unittest.TestCase):
