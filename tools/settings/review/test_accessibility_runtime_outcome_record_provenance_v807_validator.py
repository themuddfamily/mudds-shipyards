...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v807_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v807",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV807Tests(unittest.TestCase):
