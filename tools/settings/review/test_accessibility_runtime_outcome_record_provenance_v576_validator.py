...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v576_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v576",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV576Tests(unittest.TestCase):
