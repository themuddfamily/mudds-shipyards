...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v749_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v749",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV749Tests(unittest.TestCase):
