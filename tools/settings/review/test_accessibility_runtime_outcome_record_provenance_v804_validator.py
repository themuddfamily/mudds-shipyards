...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v804_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v804",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV804Tests(unittest.TestCase):
