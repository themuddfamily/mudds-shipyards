...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v795_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v795",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV795Tests(unittest.TestCase):
