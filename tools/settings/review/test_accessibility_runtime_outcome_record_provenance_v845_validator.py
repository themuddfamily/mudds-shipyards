...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v845_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v845",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV845Tests(unittest.TestCase):
