...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v896_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v896",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV896Tests(unittest.TestCase):
