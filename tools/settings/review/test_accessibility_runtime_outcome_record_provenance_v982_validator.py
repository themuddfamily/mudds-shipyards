...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v982_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v982",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV982Tests(unittest.TestCase):
