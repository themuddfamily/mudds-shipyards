...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v843_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v843",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV843Tests(unittest.TestCase):
