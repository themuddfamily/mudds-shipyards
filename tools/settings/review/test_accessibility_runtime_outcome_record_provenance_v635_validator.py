...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v635_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v635",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV635Tests(unittest.TestCase):
