...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v627_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v627",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV627Tests(unittest.TestCase):
