...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v613_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v613",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV613Tests(unittest.TestCase):
