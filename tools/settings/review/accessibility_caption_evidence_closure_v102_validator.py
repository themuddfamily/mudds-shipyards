#!/usr/bin/env python3
"""Validate v102 accessibility-caption evidence/closure evidence."""
...
SCHEMA = "accessibility_caption_evidence_closure_v102_evidence_v1"
SOURCE_SCHEMA = "accessibility_caption_audit_lineage_v101_evidence_v1"
SCHEMA_VERSION = "v102"
PREVIOUS_VERSION = "v101"
SOURCE_ID = "caption-presentation-service"
SOURCE_AUDIT_ID = "caption-accessibility-audit-v101"
EVIDENCE_ID = "caption-accessibility-evidence-v102"
...
BINDING = {
    "evidence_scope": "audit_to_closure",
    "source_id": SOURCE_ID,
...
def validate_evidence_closure(value: Any) -> list[str]:
    ...
    if value.get("binding") != BINDING:
        errors.append("binding must exactly match v101 source, authority, stale, human, and native policy")
    if value.get("evidence_closure") != EVIDENCE_CLOSURE:
        errors.append("evidence_closure must exactly match v102 evidence, closure, and open-gate policy")
    if value.get("evidence_checks") != EVIDENCE_CHECKS:
        errors.append("evidence_checks must exactly match the bounded v102 checks")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if errors:
        print("ACCESSIBILITY_CAPTION_EVIDENCE_CLOSURE_V102_INVALID")
        print("\n".join(f"- {error}" for error in errors))
        return 1
    print("ACCESSIBILITY_CAPTION_EVIDENCE_CLOSURE_V102_READY: evidence remains unverified")
    return 0
