...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v803_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v803",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV803Tests(unittest.TestCase):
