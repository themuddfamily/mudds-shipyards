...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v692_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v692",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV692Tests(unittest.TestCase):
