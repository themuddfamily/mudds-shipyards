...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v864_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v864",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV864Tests(unittest.TestCase):
