...
from tools.settings.review.accessibility_caption_attestation_lineage_v96_validator import (
    ATTESTATION_CHECKS,
    ATTESTATION_ID,
    ATTESTATION_LINEAGE,
    AUTHORITY,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-attestation-v96",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v96 attestation/lineage review or native render has been performed",
...
class AccessibilityCaptionAttestationLineageV96Tests(unittest.TestCase):
    ...
    def test_v95_source_chain_is_exact(self):
        value = _record()
        value["source_schema"] = "accessibility_caption_evidence_state_v94_evidence_v1"
        value["source_evidence_id"] = "caption-accessibility-evidence-v94"
        value["attestation_lineage"]["previous_version"] = "v94"
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v96.json", "sha256": "bad"}]
        errors = validate_attestation_lineage(value)
