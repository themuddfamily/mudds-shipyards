...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v900_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v900",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV900Tests(unittest.TestCase):
