...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v698_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v698",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV698Tests(unittest.TestCase):
