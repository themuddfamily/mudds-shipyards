...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v994_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v994",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV994Tests(unittest.TestCase):
