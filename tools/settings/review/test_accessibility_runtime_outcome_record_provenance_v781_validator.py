...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v781_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v781",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV781Tests(unittest.TestCase):
