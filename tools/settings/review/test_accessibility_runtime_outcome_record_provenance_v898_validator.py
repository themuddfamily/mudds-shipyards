...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v898_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v898",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV898Tests(unittest.TestCase):
