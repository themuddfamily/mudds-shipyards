...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v925_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v925",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV925Tests(unittest.TestCase):
