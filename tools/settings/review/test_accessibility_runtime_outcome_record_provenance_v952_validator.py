...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v952_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v952",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV952Tests(unittest.TestCase):
