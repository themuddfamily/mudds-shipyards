...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v889_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v889",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV889Tests(unittest.TestCase):
