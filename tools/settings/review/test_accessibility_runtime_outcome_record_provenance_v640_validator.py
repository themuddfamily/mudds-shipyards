...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v640_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v640",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV640Tests(unittest.TestCase):
