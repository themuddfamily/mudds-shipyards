...
from tools.settings.review.accessibility_caption_provenance_closure_v88_validator import (
    AUTHORITY,
    BINDING,
    CONTRACT_ID,
    PREVIOUS_VERSION,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-provenance-v88",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v88 provenance/closure review or native render has been performed",
...
class AccessibilityCaptionProvenanceClosureV88Tests(unittest.TestCase):
    ...
    def test_v87_source_chain_is_exact(self):
        value = _record()
        value["source_schema"] = "accessibility_caption_audit_closure_v86_evidence_v1"
        value["source_audit_id"] = "caption-accessibility-audit-v86"
        value["provenance_closure"]["previous_version"] = "v86"
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v88.json", "sha256": "bad"}]
        errors = validate_provenance_closure(value)
