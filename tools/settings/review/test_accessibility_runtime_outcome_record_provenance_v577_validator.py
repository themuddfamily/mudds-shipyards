...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v577_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v577",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV577Tests(unittest.TestCase):
