...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v559_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v559",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV559Tests(unittest.TestCase):
