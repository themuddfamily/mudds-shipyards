...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v798_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v798",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV798Tests(unittest.TestCase):
