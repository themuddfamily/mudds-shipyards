...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v748_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v748",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV748Tests(unittest.TestCase):
