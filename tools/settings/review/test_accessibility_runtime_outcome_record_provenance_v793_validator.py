...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v793_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v793",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV793Tests(unittest.TestCase):
