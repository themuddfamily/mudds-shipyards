...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v934_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v934",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV934Tests(unittest.TestCase):
