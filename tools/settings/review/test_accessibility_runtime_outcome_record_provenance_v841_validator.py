...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v841_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v841",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV841Tests(unittest.TestCase):
