...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1014_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1014",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1014Tests(unittest.TestCase):
