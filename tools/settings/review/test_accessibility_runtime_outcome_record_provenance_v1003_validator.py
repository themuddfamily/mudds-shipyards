...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1003_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1003",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1003Tests(unittest.TestCase):
