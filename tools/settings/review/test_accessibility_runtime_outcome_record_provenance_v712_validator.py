...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v712_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v712",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV712Tests(unittest.TestCase):
