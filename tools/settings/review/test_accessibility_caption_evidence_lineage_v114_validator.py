...
from tools.settings.review.accessibility_caption_evidence_lineage_v114_validator import (
    AUTHORITY,
    BINDING,
    CONTRACT_ID,
    EVIDENCE_CHECKS,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-evidence-lineage-v114",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v114 evidence/lineage review or native render has been performed",
...
class AccessibilityCaptionEvidenceLineageV114Tests(unittest.TestCase):
    ...
    def test_v113_source_chain_is_exact(self):
        value = _record()
        value["source_schema"] = "accessibility_caption_audit_state_v112_evidence_v1"
        value["source_audit_id"] = "caption-accessibility-audit-v112"
        value["evidence_lineage"]["previous_version"] = "v112"
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v114.json", "sha256": "bad"}]
        errors = validate_evidence_lineage(value)
