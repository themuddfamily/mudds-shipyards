...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1004_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1004",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1004Tests(unittest.TestCase):
