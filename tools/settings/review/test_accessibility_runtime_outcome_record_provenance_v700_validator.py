...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v700_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v700",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV700Tests(unittest.TestCase):
