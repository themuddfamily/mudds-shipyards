...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1028_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1028",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1028Tests(unittest.TestCase):
