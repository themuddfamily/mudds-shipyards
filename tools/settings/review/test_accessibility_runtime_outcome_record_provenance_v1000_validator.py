...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1000_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1000",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1000Tests(unittest.TestCase):
