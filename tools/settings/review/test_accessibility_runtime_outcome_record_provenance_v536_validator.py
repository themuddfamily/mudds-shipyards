...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v536_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v536",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV536Tests(unittest.TestCase):
