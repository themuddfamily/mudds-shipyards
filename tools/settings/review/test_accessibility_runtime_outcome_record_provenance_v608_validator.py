...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v608_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v608",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV608Tests(unittest.TestCase):
