...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v942_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v942",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV942Tests(unittest.TestCase):
