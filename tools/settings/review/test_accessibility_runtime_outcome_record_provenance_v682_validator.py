...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v682_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v682",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV682Tests(unittest.TestCase):
