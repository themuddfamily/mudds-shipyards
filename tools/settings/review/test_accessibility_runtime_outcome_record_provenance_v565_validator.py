...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v565_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v565",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV565Tests(unittest.TestCase):
