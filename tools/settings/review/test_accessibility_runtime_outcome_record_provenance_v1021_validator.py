...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1021_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1021",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1021Tests(unittest.TestCase):
