...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v907_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v907",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV907Tests(unittest.TestCase):
