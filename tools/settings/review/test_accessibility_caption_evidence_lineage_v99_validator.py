...
from tools.settings.review.accessibility_caption_evidence_lineage_v99_validator import (
    AUTHORITY,
    BINDING,
    CONTRACT_ID,
    EVIDENCE_CHECKS,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-evidence-lineage-v99",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v99 evidence/lineage review or native render has been performed",
...
class AccessibilityCaptionEvidenceLineageV99Tests(unittest.TestCase):
    ...
    def test_v98_source_chain_is_exact(self):
        value = _record()
        value["source_schema"] = "accessibility_caption_audit_closure_v97_evidence_v1"
        value["source_audit_id"] = "caption-accessibility-audit-v97"
        value["evidence_lineage"]["previous_version"] = "v97"
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v99.json", "sha256": "bad"}]
        errors = validate_evidence_lineage(value)
