...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v671_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v671",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV671Tests(unittest.TestCase):
