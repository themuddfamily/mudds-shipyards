...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v625_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v625",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV625Tests(unittest.TestCase):
