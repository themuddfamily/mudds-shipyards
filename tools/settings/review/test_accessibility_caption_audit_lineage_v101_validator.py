...
from tools.settings.review.accessibility_caption_audit_lineage_v101_validator import (
    AUDIT_CHECKS,
    AUDIT_ID,
    AUDIT_LINEAGE,
    AUTHORITY,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-audit-lineage-v101",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v101 audit/lineage review or native render has been performed",
...
class AccessibilityCaptionAuditLineageV101Tests(unittest.TestCase):
    ...
    def test_v100_source_chain_is_exact(self):
        value = _record()
        value["source_schema"] = "accessibility_caption_verification_closure_v99_evidence_v1"
        value["source_verification_id"] = "caption-accessibility-verification-v99"
        value["audit_lineage"]["previous_version"] = "v99"
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v101.json", "sha256": "bad"}]
        errors = validate_audit_lineage(value)
