...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v773_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v773",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV773Tests(unittest.TestCase):
