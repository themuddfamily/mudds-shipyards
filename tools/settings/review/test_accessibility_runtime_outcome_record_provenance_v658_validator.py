...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v658_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v658",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV658Tests(unittest.TestCase):
