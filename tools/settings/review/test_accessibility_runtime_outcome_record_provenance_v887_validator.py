...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v887_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v887",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV887Tests(unittest.TestCase):
