...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v966_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v966",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV966Tests(unittest.TestCase):
