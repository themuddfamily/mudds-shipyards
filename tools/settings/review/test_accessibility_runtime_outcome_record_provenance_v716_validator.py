...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v716_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v716",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV716Tests(unittest.TestCase):
