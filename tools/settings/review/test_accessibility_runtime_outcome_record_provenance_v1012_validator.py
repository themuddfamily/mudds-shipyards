...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1012_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1012",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1012Tests(unittest.TestCase):
