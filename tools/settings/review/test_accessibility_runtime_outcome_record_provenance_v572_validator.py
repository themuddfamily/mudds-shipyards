...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v572_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v572",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV572Tests(unittest.TestCase):
