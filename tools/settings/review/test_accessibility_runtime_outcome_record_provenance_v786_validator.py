...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v786_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v786",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV786Tests(unittest.TestCase):
