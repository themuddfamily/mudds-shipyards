...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v808_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v808",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV808Tests(unittest.TestCase):
