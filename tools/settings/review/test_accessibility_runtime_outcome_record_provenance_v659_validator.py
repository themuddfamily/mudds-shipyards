...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v659_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v659",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV659Tests(unittest.TestCase):
