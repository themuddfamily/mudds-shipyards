...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v882_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v882",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV882Tests(unittest.TestCase):
