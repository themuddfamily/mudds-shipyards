...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v667_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v667",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV667Tests(unittest.TestCase):
