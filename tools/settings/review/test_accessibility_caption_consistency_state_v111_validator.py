...
from tools.settings.review.accessibility_caption_consistency_state_v111_validator import (
    AUTHORITY,
    BINDING,
    CONSISTENCY_CHECKS,
    CONSISTENCY_ID,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-consistency-state-v111",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v111 consistency/state review or native render has been performed",
...
class AccessibilityCaptionConsistencyStateV111Tests(unittest.TestCase):
    ...
    def test_v110_source_chain_is_exact(self):
        value = _record()
        value["source_schema"] = "accessibility_caption_evidence_lineage_v109_evidence_v1"
        value["source_evidence_id"] = "caption-accessibility-evidence-v109"
        value["consistency_state"]["previous_version"] = "v109"
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v111.json", "sha256": "bad"}]
        errors = validate_consistency_state(value)
