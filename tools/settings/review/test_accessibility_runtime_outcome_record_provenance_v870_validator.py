...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v870_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v870",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV870Tests(unittest.TestCase):
