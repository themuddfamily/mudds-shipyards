...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1027_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1027",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1027Tests(unittest.TestCase):
