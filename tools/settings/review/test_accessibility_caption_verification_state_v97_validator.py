...
from tools.settings.review.accessibility_caption_verification_state_v97_validator import (
    AUTHORITY,
    BINDING,
    CONTRACT_ID,
    PREVIOUS_VERSION,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-verification-state-v97",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v97 verification/state review or native render has been performed",
...
class AccessibilityCaptionVerificationStateV97Tests(unittest.TestCase):
    ...
    def test_v96_source_chain_is_exact(self):
        value = _record()
        value["source_schema"] = "accessibility_caption_attestation_lineage_v95_evidence_v1"
        value["source_attestation_id"] = "caption-accessibility-attestation-v95"
        value["verification_state"]["previous_version"] = "v95"
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v97.json", "sha256": "bad"}]
        errors = validate_verification_state(value)
