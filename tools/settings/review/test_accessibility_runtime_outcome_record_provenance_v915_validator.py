...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v915_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v915",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV915Tests(unittest.TestCase):
