...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v725_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v725",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV725Tests(unittest.TestCase):
