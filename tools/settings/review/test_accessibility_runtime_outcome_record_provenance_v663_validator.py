...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v663_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v663",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV663Tests(unittest.TestCase):
