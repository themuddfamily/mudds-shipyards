...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v731_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v731",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV731Tests(unittest.TestCase):
