...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v836_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v836",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV836Tests(unittest.TestCase):
