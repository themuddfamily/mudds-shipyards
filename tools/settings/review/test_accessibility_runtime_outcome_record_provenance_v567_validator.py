...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v567_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v567",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV567Tests(unittest.TestCase):
