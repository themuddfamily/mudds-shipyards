...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v706_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v706",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV706Tests(unittest.TestCase):
