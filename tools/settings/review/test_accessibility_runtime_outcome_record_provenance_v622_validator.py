...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v622_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v622",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV622Tests(unittest.TestCase):
