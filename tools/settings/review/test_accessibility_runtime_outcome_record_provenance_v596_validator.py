...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v596_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v596",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV596Tests(unittest.TestCase):
