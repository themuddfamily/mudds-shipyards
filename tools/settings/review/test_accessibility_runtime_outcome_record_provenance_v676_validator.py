...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v676_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v676",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV676Tests(unittest.TestCase):
