...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v727_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v727",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV727Tests(unittest.TestCase):
