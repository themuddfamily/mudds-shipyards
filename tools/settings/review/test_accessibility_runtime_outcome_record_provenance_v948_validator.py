...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v948_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v948",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV948Tests(unittest.TestCase):
