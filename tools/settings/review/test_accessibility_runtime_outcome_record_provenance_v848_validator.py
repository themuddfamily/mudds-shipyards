...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v848_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v848",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV848Tests(unittest.TestCase):
