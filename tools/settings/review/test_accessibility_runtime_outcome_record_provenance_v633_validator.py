...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v633_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v633",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV633Tests(unittest.TestCase):
