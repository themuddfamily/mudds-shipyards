...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v975_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v975",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV975Tests(unittest.TestCase):
