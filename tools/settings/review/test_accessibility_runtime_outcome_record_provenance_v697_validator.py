...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v697_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v697",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV697Tests(unittest.TestCase):
