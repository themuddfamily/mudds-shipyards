...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v929_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v929",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV929Tests(unittest.TestCase):
