"""Validate v496 accessibility runtime outcome provenance."""
from __future__ import annotations
import json
from pathlib import Path
from tools.settings.review import accessibility_runtime_outcome_record_provenance_v306_validator as base

SCHEMA = "accessibility_runtime_outcome_record_provenance_v496_evidence_v1"
...
def validate_runtime_outcome_record_provenance(value):
    ...
    if value.get("schema_version") != "v496": errors.append("schema_version")
    return errors
