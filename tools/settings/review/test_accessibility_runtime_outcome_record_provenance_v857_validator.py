...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v857_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v857",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV857Tests(unittest.TestCase):
