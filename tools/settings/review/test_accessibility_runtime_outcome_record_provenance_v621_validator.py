...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v621_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v621",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV621Tests(unittest.TestCase):
