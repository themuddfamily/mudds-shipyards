...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v895_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v895",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV895Tests(unittest.TestCase):
