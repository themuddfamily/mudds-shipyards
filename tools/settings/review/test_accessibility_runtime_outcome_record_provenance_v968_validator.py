...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v968_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v968",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV968Tests(unittest.TestCase):
