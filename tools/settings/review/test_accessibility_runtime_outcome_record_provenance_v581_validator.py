...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v581_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v581",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV581Tests(unittest.TestCase):
