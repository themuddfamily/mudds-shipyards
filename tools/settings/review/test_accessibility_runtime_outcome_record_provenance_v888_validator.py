...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v888_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v888",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV888Tests(unittest.TestCase):
