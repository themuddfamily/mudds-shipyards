...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v818_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v818",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV818Tests(unittest.TestCase):
