...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1019_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1019",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1019Tests(unittest.TestCase):
