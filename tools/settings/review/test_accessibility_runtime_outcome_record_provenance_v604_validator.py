...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v604_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v604",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV604Tests(unittest.TestCase):
