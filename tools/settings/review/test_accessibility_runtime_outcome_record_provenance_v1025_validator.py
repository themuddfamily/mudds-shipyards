...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1025_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1025",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1025Tests(unittest.TestCase):
