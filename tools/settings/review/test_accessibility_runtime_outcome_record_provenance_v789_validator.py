...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v789_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v789",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV789Tests(unittest.TestCase):
