...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v935_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v935",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV935Tests(unittest.TestCase):
