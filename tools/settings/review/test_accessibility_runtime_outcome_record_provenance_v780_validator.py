...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v780_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v780",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV780Tests(unittest.TestCase):
