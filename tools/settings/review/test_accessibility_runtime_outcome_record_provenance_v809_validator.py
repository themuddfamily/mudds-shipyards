...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v809_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v809",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV809Tests(unittest.TestCase):
