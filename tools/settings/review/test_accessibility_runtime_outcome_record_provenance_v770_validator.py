...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v770_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v770",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV770Tests(unittest.TestCase):
