...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v738_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v738",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV738Tests(unittest.TestCase):
