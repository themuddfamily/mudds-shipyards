...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v885_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v885",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV885Tests(unittest.TestCase):
