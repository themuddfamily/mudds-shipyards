...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v722_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v722",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV722Tests(unittest.TestCase):
