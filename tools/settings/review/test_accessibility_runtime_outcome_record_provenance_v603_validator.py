...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v603_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v603",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV603Tests(unittest.TestCase):
