...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v587_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v587",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV587Tests(unittest.TestCase):
