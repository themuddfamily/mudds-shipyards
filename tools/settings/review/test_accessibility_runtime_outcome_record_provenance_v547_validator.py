...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v547_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v547",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV547Tests(unittest.TestCase):
