...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v719_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v719",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV719Tests(unittest.TestCase):
