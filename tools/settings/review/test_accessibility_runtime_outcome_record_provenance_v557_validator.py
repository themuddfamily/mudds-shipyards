...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v557_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v557",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV557Tests(unittest.TestCase):
