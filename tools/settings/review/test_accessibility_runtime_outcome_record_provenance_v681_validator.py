...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v681_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v681",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV681Tests(unittest.TestCase):
