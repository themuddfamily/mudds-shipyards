...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v573_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v573",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV573Tests(unittest.TestCase):
