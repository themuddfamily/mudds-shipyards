...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v880_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v880",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV880Tests(unittest.TestCase):
