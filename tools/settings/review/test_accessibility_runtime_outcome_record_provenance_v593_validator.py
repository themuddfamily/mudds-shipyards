...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v593_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v593",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV593Tests(unittest.TestCase):
