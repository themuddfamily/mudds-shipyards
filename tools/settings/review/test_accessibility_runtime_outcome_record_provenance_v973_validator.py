...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v973_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v973",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV973Tests(unittest.TestCase):
