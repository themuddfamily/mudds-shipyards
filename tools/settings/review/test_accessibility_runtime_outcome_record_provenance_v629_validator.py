...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v629_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v629",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV629Tests(unittest.TestCase):
