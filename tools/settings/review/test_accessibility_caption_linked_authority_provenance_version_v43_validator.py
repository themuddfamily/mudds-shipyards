...
from tools.settings.review.accessibility_caption_linked_authority_provenance_version_v43_validator import (
    AUTHORITY,
    BINDING,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-linked-provenance-version-v43",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v43 linked authority/provenance/version review or native render has been performed",
...
class AccessibilityCaptionLinkedAuthorityProvenanceVersionV43Tests(unittest.TestCase):
    ...
    def test_linked_authority_provenance_version_and_binding_are_exact(self):
        ...
        self.assertTrue(any("schema_version must be v43" in error for error in errors))
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v43.json", "sha256": "bad"}]
        errors = validate_linked_authority_provenance_version(value)
