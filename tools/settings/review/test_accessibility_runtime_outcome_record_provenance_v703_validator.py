...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v703_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v703",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV703Tests(unittest.TestCase):
