...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1024_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1024",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1024Tests(unittest.TestCase):
