...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v990_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v990",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV990Tests(unittest.TestCase):
