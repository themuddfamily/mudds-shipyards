...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v946_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v946",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV946Tests(unittest.TestCase):
