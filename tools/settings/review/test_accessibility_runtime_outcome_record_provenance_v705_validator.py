...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v705_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v705",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV705Tests(unittest.TestCase):
