...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v766_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v766",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV766Tests(unittest.TestCase):
