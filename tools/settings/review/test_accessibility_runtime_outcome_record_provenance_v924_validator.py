...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v924_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v924",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV924Tests(unittest.TestCase):
