...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v938_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v938",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV938Tests(unittest.TestCase):
