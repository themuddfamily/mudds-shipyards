...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v1011_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v1011",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV1011Tests(unittest.TestCase):
