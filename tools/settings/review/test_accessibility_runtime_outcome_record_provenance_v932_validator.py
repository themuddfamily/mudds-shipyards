...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v932_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v932",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV932Tests(unittest.TestCase):
