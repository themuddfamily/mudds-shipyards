...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v717_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v717",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV717Tests(unittest.TestCase):
