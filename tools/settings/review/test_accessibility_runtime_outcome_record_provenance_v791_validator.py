...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v791_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v791",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV791Tests(unittest.TestCase):
