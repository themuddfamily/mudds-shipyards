...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v263_validator import (
...
def _record() -> dict:
    return {"schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": SCHEMA_VERSION,
            "source_revision": "working-tree-runtime-outcome-record-v263",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV263Tests(unittest.TestCase):
