...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v813_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v813",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV813Tests(unittest.TestCase):
