...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v732_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v732",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV732Tests(unittest.TestCase):
