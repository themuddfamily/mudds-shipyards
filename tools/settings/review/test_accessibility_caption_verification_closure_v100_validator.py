...
from tools.settings.review.accessibility_caption_verification_closure_v100_validator import (
    AUTHORITY,
    BINDING,
    CONTRACT_ID,
    PREVIOUS_VERSION,
...
def _record() -> dict:
    return {
        ...
        "source_revision": "working-tree-caption-verification-v100",
        "reviewer_required": "human accessibility and caption QA",
        "open_gate_reason": "no human v100 verification/closure review or native render has been performed",
...
class AccessibilityCaptionVerificationClosureV100Tests(unittest.TestCase):
    ...
    def test_v99_source_chain_is_exact(self):
        value = _record()
        value["source_schema"] = "accessibility_caption_evidence_lineage_v98_evidence_v1"
        value["source_evidence_id"] = "caption-accessibility-evidence-v98"
        value["verification_closure"]["previous_version"] = "v98"
    ...
    def test_evidence_requires_sha256_metadata(self):
        value = _record()
        value["evidence"] = [{"kind": "report", "path": "reports/v100.json", "sha256": "bad"}]
        errors = validate_verification_closure(value)
