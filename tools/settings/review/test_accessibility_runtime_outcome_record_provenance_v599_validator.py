...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v599_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v599",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV599Tests(unittest.TestCase):
