...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v920_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v920",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV920Tests(unittest.TestCase):
