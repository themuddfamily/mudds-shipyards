...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v826_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v826",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV826Tests(unittest.TestCase):
