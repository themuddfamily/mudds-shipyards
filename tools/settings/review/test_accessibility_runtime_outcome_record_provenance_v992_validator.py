...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v992_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v992",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV992Tests(unittest.TestCase):
