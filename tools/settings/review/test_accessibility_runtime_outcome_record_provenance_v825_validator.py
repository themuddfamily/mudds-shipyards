...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v825_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v825",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV825Tests(unittest.TestCase):
