...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v926_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v926",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV926Tests(unittest.TestCase):
