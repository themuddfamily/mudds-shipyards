...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v909_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v909",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV909Tests(unittest.TestCase):
