...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v816_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v816",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV816Tests(unittest.TestCase):
