...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v648_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v648",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV648Tests(unittest.TestCase):
