...
from tools.settings.review.accessibility_runtime_outcome_record_provenance_v824_validator import (
...
def record():
    return {
        "schema": SCHEMA, "source_schema": SOURCE_SCHEMA, "schema_version": "v824",
...
class AccessibilityRuntimeOutcomeRecordProvenanceV824Tests(unittest.TestCase):
