#!/usr/bin/env python3
"""Validate v761 planetary-hazard review evidence without runtime effects."""
...
SCHEMA = "planetary_hazard_review_v761"
VERSION = 761
...
FIXED = {
    ...
    "evidence_class": "planetary_hazard", "evidence_contract": "planetary_hazard_review", "evidence_revision": "v761",
...
def main(argv: list[str] | None = None) -> int:
    ...
    if errors:
        print("PLANETARY_HAZARD_REVIEW_V761_INVALID"); print("\n".join(f"- {error}" for e in errors)); return 1
    print("PLANETARY_HAZARD_REVIEW_V761_VALID_OPEN"); return 0
