#!/usr/bin/env python3
"""Validate v765 planetary-hazard review evidence without runtime effects."""
...
SCHEMA = "planetary_hazard_review_v765"
VERSION = 765
...
FIXED = {
    ...
    "evidence_class": "planetary_hazard", "evidence_contract": "planetary_hazard_review", "evidence_revision": "v765",
...
def main(argv: list[str] | None = None) -> int:
    ...
    if errors:
        print("PLANETARY_HAZARD_REVIEW_V765_INVALID"); print("\n".join(f"- {error}" for e in errors)); return 1
    print("PLANETARY_HAZARD_REVIEW_V765_VALID_OPEN"); return 0
