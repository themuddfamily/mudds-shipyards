#!/usr/bin/env python3
"""Validate v778 planetary-hazard review evidence without runtime effects."""
...
SCHEMA = "planetary_hazard_review_v778"
VERSION = 778
...
FIXED = {
    ...
    "evidence_class": "planetary_hazard", "evidence_contract": "planetary_hazard_review", "evidence_revision": "v778",
...
def main(argv: list[str] | None = None) -> int:
    ...
    if errors:
        print("PLANETARY_HAZARD_REVIEW_V778_INVALID"); print("\n".join(f"- {error}" for error in errors)); return 1
    print("PLANETARY_HAZARD_REVIEW_V778_VALID_OPEN"); return 0
