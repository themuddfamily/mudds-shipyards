#!/usr/bin/env python3
"""Validate v120 planetary-hazard review consistency evidence."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if errors:
        print("PLANETARY_HAZARD_REVIEW_CONSISTENCY_V120_INVALID")
        print("\n".join(f"- {error}" for error in errors))
        return 1
    print("PLANETARY_HAZARD_REVIEW_CONSISTENCY_V120_VALID_OPEN")
    return 0
