...
from tools.package.source_hash_audit_closure_v97 import validate_v97
...
def record():
    ...
    source_id = "source-97"
    audit_id = "audit-97"
    closure_id = "closure-97"
    source_version = "src-97"
...
class SourceHashAuditClosureV97Test(unittest.TestCase):
    ...
    def test_rejects_schema_or_closure_flags(self):
        ...
        errors = validate_v97(item)
        self.assertTrue(any("schema_version must be 97" in error for error in errors))
    ...
    def test_native_not_run_cannot_carry_platform(self):
        ...
        self.assertTrue(any("platform must be null" in error for error in validate_v97(item)))
