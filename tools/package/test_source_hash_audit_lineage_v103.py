...
from tools.package.source_hash_audit_lineage_v103 import validate_v103
...
def record():
    ...
    return {
        "schema_version": 103,
        "build_label": "audit-lineage-v103",
        **common,
        "audit_id": audit_id,
...
class SourceHashAuditLineageV103Test(unittest.TestCase):
    ...
    def test_rejects_schema_or_lineage_flags(self):
        ...
        errors = validate_v103(item)
        self.assertTrue(any("schema_version must be 103" in error for error in errors))
    ...
    def test_native_not_run_cannot_carry_platform(self):
        ...
        self.assertTrue(any("platform must be null" in error for error in validate_v103(item)))
