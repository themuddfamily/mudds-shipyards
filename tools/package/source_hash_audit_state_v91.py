#!/usr/bin/env python3
"""Validate version-91 source-hash audit and state evidence."""
...
def validate_v91(value: Any, label: str = "audit_state_v91") -> list[str]:
...
def main(argv: list[str] | None = None) -> int:
    ...
    errors = validate_v91(json.loads(args.record.read_text(encoding="utf-8")))
    if errors:
        print("SOURCE_HASH_AUDIT_STATE_V91_INVALID")
        print("\n".join(f"- {error}" for error in errors))
        return 1
    print("SOURCE_HASH_AUDIT_STATE_V91_VALID")
    return 0
