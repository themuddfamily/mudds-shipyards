...
from tools.package.source_hash_provenance_v327 import validate_v327

def record() -> dict:
    binding = {"source_id": "source-327", "source_commit": "b" * 40, "source_hash": "c" * 64,
               "package_version": "32.7.0", "source_artifact_hash_count": 2,
               "package_artifact_hash_count": 3, "authorization_attestation_id": "authorization-attestation-327",
    ...
    return {"schema_version": 327, "build_label": "source-provenance-v327", **binding,
            "source": {"status": "PASS", "evidence": "source", **binding, "identified": True},
            "authorization_attestation": {"status": "PASS", "evidence": "attestation",
                "authorization_attestation_id": "authorization-attestation-327",
...
class SourceHashProvenanceV327Test(unittest.TestCase):
    def test_accepts_attestation_binding_and_not_run_gates(self):
        self.assertEqual(validate_v327(record()), [])
    ...
    def test_rejects_schema_or_authorized_flag(self):
        ...
        errors = validate_v327(item)
        self.assertTrue(any("schema_version must be 327" in error for error in errors))
