...
from tools.package.source_hash_audit_lineage_v93 import validate_v93
...
def record():
    ...
    source_id = "source-93"
    audit_id = "audit-93"
    lineage_id = "lineage-93"
    source_version = "src-93"
...
class SourceHashAuditLineageV93Test(unittest.TestCase):
    ...
    def test_rejects_schema_or_lineage_flags(self):
        ...
        errors = validate_v93(item)
        self.assertTrue(any("schema_version must be 93" in error for error in errors))
    ...
    def test_native_not_run_cannot_carry_platform(self):
        ...
        self.assertTrue(any("platform must be null" in error for error in validate_v93(item)))
