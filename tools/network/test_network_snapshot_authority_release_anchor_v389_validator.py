...
try:
    from .network_snapshot_authority_release_anchor_v389_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_release_anchor_v389_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-release-anchor-assertion-v1",
        "integrity_gate_id": "authority-release-anchor-v389",
        "snapshot_id": "snapshot-authority-v272", "authority": "server", "sequence": 43789,
...
def _report():
    ...
    return {
        "schema_version": 389,
        "evidence_scope": "network_snapshot_authority_release_anchor_v389",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "integrity_gate_id": "authority-release-anchor-v389",
        "snapshot_id": "snapshot-authority-v272",
        "assertion_id": "authority-snapshot-release-anchor-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 161, "release": "release-1",
...
class NetworkSnapshotAuthorityReleaseAnchorV389ValidatorTest(unittest.TestCase):
    def test_accepts_release_anchor_rollup(self):
        self.assertEqual(validate_snapshot(_report()), [])

    def test_rejects_release_anchor_binding(self):
        report = _report()
        report["assertion_members"][0]["assertion_id"] = "wrong-release"
        errors = validate_snapshot(report)
        self.assertTrue(any("bind authority release anchor" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        report["assertion_members"][0]["mutation_fields"] = ["release"]
