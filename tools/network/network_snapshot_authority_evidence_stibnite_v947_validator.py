#!/usr/bin/env python3
"""Validate detached v947 authority/snapshot evidence-stibnite evidence."""
from __future__ import annotations
import argparse,hashlib,json,re
from pathlib import Path
from typing import Any

SCHEMA_VERSION=947;EVIDENCE_SCOPE="network_snapshot_authority_evidence_stibnite_v947";EVIDENCE_MODE="detached_contract_fixture";POLICY_VERSION="network_replication_interest_authority_v1";AUTHORITY="server";INTEGRITY_GATE_ID="authority-evidence-stibnite-v947";SNAPSHOT_ID="snapshot-authority-v830";ASSERTION_ID="authority-snapshot-evidence-stibnite-assertion-v1";SOURCE="server_snapshot";SNAPSHOT_VERSION=719;RELEASE_ID="release-1";SHA256=re.compile(r"^[0-9a-f]{64}$");NOT_RUN_CHECKS=("stale_check","native_run","hardware_run","human_review")
...
def main()->int:
 ...
 if e:
  print("NETWORK_SNAPSHOT_AUTHORITY_EVIDENCE_STIBNITE_V947_INVALID")
  for x in e:print(f"- {x}")
  return 1
 print("NETWORK_SNAPSHOT_AUTHORITY_EVIDENCE_STIBNITE_V947_VALID");return 0
