...
try:
    from .network_snapshot_authority_health_v367_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_health_v367_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-health-assertion-v1", "health_id": "authority-health-v367",
        "snapshot_id": "snapshot-authority-v250", "authority": "server", "sequence": 42442,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "health_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 367,
        "evidence_scope": "network_snapshot_authority_health_v367",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "health_id": "authority-health-v367",
        "snapshot_id": "snapshot-authority-v250", "assertion_id": "authority-snapshot-health-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 139, "release": "release-1",
        ...
        "snapshot": {
            "health_id": "authority-health-v367", "snapshot_id": "snapshot-authority-v250",
            "assertion_id": "authority-snapshot-health-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 139,
            "sequence": 42442, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityHealthV367ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority health" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority health members" in error for error in errors))
