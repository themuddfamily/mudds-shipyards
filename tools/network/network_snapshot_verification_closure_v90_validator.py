#!/usr/bin/env python3
"""Validate detached v90 snapshot verification/closure evidence."""
...
SCHEMA_VERSION = 90
EVIDENCE_SCOPE = "network_snapshot_verification_closure_v90"
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_VERIFICATION_CLOSURE_V90_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_VERIFICATION_CLOSURE_V90_VALID")
    return 0
