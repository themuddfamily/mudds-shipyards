#!/usr/bin/env python3
"""Validate detached v198 network snapshot authority-attestation evidence."""
...
SCHEMA_VERSION = 198
EVIDENCE_SCOPE = "network_snapshot_authority_attestation_v198"
EVIDENCE_MODE = "detached_contract_fixture"
POLICY_VERSION = "network_replication_interest_authority_v1"
AUTHORITY = "server"
AUTHORITY_ATTESTATION = "server-authority-attestation-v1"
SNAPSHOT_ID = "snapshot-authority-v81"
...
def _attestation_digest(record: dict[str, Any]) -> str:
    fields = (
        "authority_attestation", "snapshot_id", "authority", "source", "release",
...
def validate_snapshot(report: Any, label: str = "snapshot") -> list[str]:
    ...
    if not isinstance(snapshot, dict):
        ...
        snapshot = {}
    snapshot_fields = (
        ("authority_attestation", report.get("authority_attestation")),
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_AUTHORITY_ATTESTATION_V198_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_AUTHORITY_ATTESTATION_V198_VALID")
    return 0
