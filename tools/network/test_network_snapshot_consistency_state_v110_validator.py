...
try:
    from .network_snapshot_consistency_state_v110_validator import validate_snapshot
except ImportError:
    from network_snapshot_consistency_state_v110_validator import validate_snapshot
...
class NetworkSnapshotConsistencyStateV110ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_consistency_binding(self):
        report = _report()
        report["records"][0]["consistency_id"] = "snapshot-consistency-v4"
