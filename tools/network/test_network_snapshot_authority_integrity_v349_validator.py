...
try:
    from .network_snapshot_authority_integrity_v349_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_integrity_v349_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-integrity-assertion-v1", "integrity_id": "authority-integrity-v349",
        "snapshot_id": "snapshot-authority-v232", "authority": "server", "sequence": 42424,
...
def _report():
    ...
    return {
        "schema_version": 349,
        "evidence_scope": "network_snapshot_authority_integrity_v349",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "integrity_id": "authority-integrity-v349",
        "snapshot_id": "snapshot-authority-v232", "assertion_id": "authority-snapshot-integrity-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 121, "release": "release-1",
        ...
        "snapshot": {
            "integrity_id": "authority-integrity-v349", "snapshot_id": "snapshot-authority-v232",
            "assertion_id": "authority-snapshot-integrity-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 121,
            "sequence": 42424, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityIntegrityV349ValidatorTest(unittest.TestCase):
