...
try:
    from .network_snapshot_authority_audit_v351_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_audit_v351_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-audit-assertion-v1", "audit_id": "authority-audit-v351",
        "snapshot_id": "snapshot-authority-v234", "authority": "server", "sequence": 42426,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "audit_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 351,
        "evidence_scope": "network_snapshot_authority_audit_v351",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "audit_id": "authority-audit-v351",
        "snapshot_id": "snapshot-authority-v234", "assertion_id": "authority-snapshot-audit-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 123, "release": "release-1",
        ...
        "snapshot": {
            "audit_id": "authority-audit-v351", "snapshot_id": "snapshot-authority-v234",
            "assertion_id": "authority-snapshot-audit-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 123,
            "sequence": 42426, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityAuditV351ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority audit" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority audit members" in error for error in errors))
