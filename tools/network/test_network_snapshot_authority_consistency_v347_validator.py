...
try:
    from .network_snapshot_authority_consistency_v347_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_consistency_v347_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-consistency-assertion-v1", "consistency_id": "authority-consistency-v347",
        "snapshot_id": "snapshot-authority-v230", "authority": "server", "sequence": 42422,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "consistency_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 347,
        "evidence_scope": "network_snapshot_authority_consistency_v347",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "consistency_id": "authority-consistency-v347",
        "snapshot_id": "snapshot-authority-v230", "assertion_id": "authority-snapshot-consistency-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 119, "release": "release-1",
        ...
        "snapshot": {
            "consistency_id": "authority-consistency-v347", "snapshot_id": "snapshot-authority-v230",
            "assertion_id": "authority-snapshot-consistency-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 119,
            "sequence": 42422, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityConsistencyV347ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority consistency" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority consistency members" in error for error in errors))
