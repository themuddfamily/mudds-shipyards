...
try:
    from .network_snapshot_authority_traceability_v350_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_traceability_v350_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-traceability-assertion-v1", "traceability_id": "authority-traceability-v350",
        "snapshot_id": "snapshot-authority-v233", "authority": "server", "sequence": 42425,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "traceability_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 350,
        "evidence_scope": "network_snapshot_authority_traceability_v350",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "traceability_id": "authority-traceability-v350",
        "snapshot_id": "snapshot-authority-v233", "assertion_id": "authority-snapshot-traceability-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 122, "release": "release-1",
        ...
        "snapshot": {
            "traceability_id": "authority-traceability-v350", "snapshot_id": "snapshot-authority-v233",
            "assertion_id": "authority-snapshot-traceability-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 122,
            "sequence": 42425, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityTraceabilityV350ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority traceability" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority traceability members" in error for error in errors))
