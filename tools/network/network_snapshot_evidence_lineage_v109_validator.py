#!/usr/bin/env python3
"""Validate detached v109 snapshot evidence/lineage evidence."""
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_EVIDENCE_LINEAGE_V109_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_EVIDENCE_LINEAGE_V109_VALID")
    return 0
