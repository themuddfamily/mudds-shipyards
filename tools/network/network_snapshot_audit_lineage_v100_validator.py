#!/usr/bin/env python3
"""Validate detached v100 snapshot audit/lineage evidence."""
...
SCHEMA_VERSION = 100
EVIDENCE_SCOPE = "network_snapshot_audit_lineage_v100"
EVIDENCE_MODE = "detached_contract_fixture"
POLICY_VERSION = "network_replication_interest_authority_v1"
AUTHORITY = "server"
AUDIT_ID = "snapshot-audit-v3"
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_AUDIT_LINEAGE_V100_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_AUDIT_LINEAGE_V100_VALID")
    return 0
