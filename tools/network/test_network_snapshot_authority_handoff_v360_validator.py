...
try:
    from .network_snapshot_authority_handoff_v360_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_handoff_v360_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-handoff-assertion-v1", "handoff_id": "authority-handoff-v360",
        "snapshot_id": "snapshot-authority-v243", "authority": "server", "sequence": 42435,
...
def _report():
    ...
    return {
        "schema_version": 360,
        "evidence_scope": "network_snapshot_authority_handoff_v360",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "handoff_id": "authority-handoff-v360",
        "snapshot_id": "snapshot-authority-v243", "assertion_id": "authority-snapshot-handoff-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 132, "release": "release-1",
        ...
        "snapshot": {
            "handoff_id": "authority-handoff-v360", "snapshot_id": "snapshot-authority-v243",
            "assertion_id": "authority-snapshot-handoff-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 132,
            "sequence": 42435, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityHandoffV360ValidatorTest(unittest.TestCase):
