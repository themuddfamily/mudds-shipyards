#!/usr/bin/env python3
"""Validate detached v360 authority/snapshot handoff evidence."""
...
AUTHORITY = "server"
HANDOFF_ID = "authority-handoff-v360"
SNAPSHOT_ID = "snapshot-authority-v243"
ASSERTION_ID = "authority-snapshot-handoff-assertion-v1"
SOURCE = "server_snapshot"
SNAPSHOT_VERSION = 132
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_AUTHORITY_HANDOFF_V360_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_AUTHORITY_HANDOFF_V360_VALID")
    return 0
