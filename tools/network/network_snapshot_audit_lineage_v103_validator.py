#!/usr/bin/env python3
"""Validate detached v103 snapshot audit/lineage evidence."""
...
def validate_snapshot(report: Any, label: str = "snapshot") -> list[str]:
    """Return errors for detached audit/lineage snapshot evidence."""
    errors: list[str] = []
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_AUDIT_LINEAGE_V103_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_AUDIT_LINEAGE_V103_VALID")
    return 0
