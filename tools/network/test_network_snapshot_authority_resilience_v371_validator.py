...
try:
    from .network_snapshot_authority_resilience_v371_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_resilience_v371_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-resilience-assertion-v1", "resilience_id": "authority-resilience-v371",
        "snapshot_id": "snapshot-authority-v254", "authority": "server", "sequence": 42446,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "resilience_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 371,
        "evidence_scope": "network_snapshot_authority_resilience_v371",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "resilience_id": "authority-resilience-v371",
        "snapshot_id": "snapshot-authority-v254", "assertion_id": "authority-snapshot-resilience-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 143, "release": "release-1",
        ...
        "snapshot": {
            "resilience_id": "authority-resilience-v371", "snapshot_id": "snapshot-authority-v254",
            "assertion_id": "authority-snapshot-resilience-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 143,
            "sequence": 42446, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityResilienceV371ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority resilience" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority resilience members" in error for error in errors))
