...
try:
    from .network_snapshot_authority_provenance_witness_v406_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_provenance_witness_v406_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-provenance-witness-assertion-v1",
        "integrity_gate_id": "authority-provenance-witness-v406",
        "snapshot_id": "snapshot-authority-v289", "authority": "server", "sequence": 45506,
...
def _report():
    ...
    return {
        "schema_version": 406,
        "evidence_scope": "network_snapshot_authority_provenance_witness_v406",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "integrity_gate_id": "authority-provenance-witness-v406",
        "snapshot_id": "snapshot-authority-v289",
        "assertion_id": "authority-snapshot-provenance-witness-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 178, "release": "release-1",
...
class NetworkSnapshotAuthorityProvenanceWitnessV406ValidatorTest(unittest.TestCase):
    def test_accepts_provenance_witness_rollup(self):
        self.assertEqual(validate_snapshot(_report()), [])

    def test_rejects_provenance_witness_binding(self):
        report = _report()
        report["assertion_members"][0]["snapshot_id"] = "wrong-provenance"
        errors = validate_snapshot(report)
        self.assertTrue(any("bind authority provenance witness" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        report["assertion_members"][0]["mutation_fields"] = ["provenance"]
