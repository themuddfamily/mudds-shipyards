#!/usr/bin/env python3
"""Validate detached v95 snapshot attestation/lineage evidence."""
...
SCHEMA_VERSION = 95
EVIDENCE_SCOPE = "network_snapshot_attestation_lineage_v95"
EVIDENCE_MODE = "detached_contract_fixture"
POLICY_VERSION = "network_replication_interest_authority_v1"
AUTHORITY = "server"
ATTESTATION = "server-attestation-v3"
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_ATTESTATION_LINEAGE_V95_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_ATTESTATION_LINEAGE_V95_VALID")
    return 0
