...
try:
    from .network_snapshot_authority_integrity_witness_v407_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_integrity_witness_v407_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-integrity-witness-assertion-v1",
        "integrity_gate_id": "authority-integrity-witness-v407",
        "snapshot_id": "snapshot-authority-v290", "authority": "server", "sequence": 45607,
...
def _report():
    ...
    return {
        "schema_version": 407,
        "evidence_scope": "network_snapshot_authority_integrity_witness_v407",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "integrity_gate_id": "authority-integrity-witness-v407",
        "snapshot_id": "snapshot-authority-v290",
        "assertion_id": "authority-snapshot-integrity-witness-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 179, "release": "release-1",
...
class NetworkSnapshotAuthorityIntegrityWitnessV407ValidatorTest(unittest.TestCase):
    def test_accepts_integrity_witness_rollup(self):
        self.assertEqual(validate_snapshot(_report()), [])

    def test_rejects_integrity_witness_binding(self):
        report = _report()
        report["assertion_members"][0]["snapshot_id"] = "wrong-integrity"
        errors = validate_snapshot(report)
        self.assertTrue(any("bind authority integrity witness" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        report["assertion_members"][0]["mutation_fields"] = ["integrity"]
