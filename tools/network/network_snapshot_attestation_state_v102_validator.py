#!/usr/bin/env python3
"""Validate detached v102 snapshot attestation/state evidence."""
...
SCHEMA_VERSION = 102
EVIDENCE_SCOPE = "network_snapshot_attestation_state_v102"
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_ATTESTATION_STATE_V102_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_ATTESTATION_STATE_V102_VALID")
    return 0
