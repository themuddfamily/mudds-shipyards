...
try:
    from .network_snapshot_authority_evidence_witness_v392_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_evidence_witness_v392_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-evidence-witness-assertion-v1",
        "integrity_gate_id": "authority-evidence-witness-v392",
        "snapshot_id": "snapshot-authority-v275", "authority": "server", "sequence": 44092,
...
def _report():
    ...
    return {
        "schema_version": 392,
        "evidence_scope": "network_snapshot_authority_evidence_witness_v392",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "integrity_gate_id": "authority-evidence-witness-v392",
        "snapshot_id": "snapshot-authority-v275",
        "assertion_id": "authority-snapshot-evidence-witness-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 164, "release": "release-1",
...
class NetworkSnapshotAuthorityEvidenceWitnessV392ValidatorTest(unittest.TestCase):
    def test_accepts_evidence_witness_rollup(self):
        self.assertEqual(validate_snapshot(_report()), [])

    def test_rejects_evidence_witness_binding(self):
        report = _report()
        report["assertion_members"][0]["snapshot_id"] = "wrong-evidence"
        errors = validate_snapshot(report)
        self.assertTrue(any("bind authority evidence witness" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        report["assertion_members"][0]["mutation_fields"] = ["evidence"]
