#!/usr/bin/env python3
"""Validate detached v91 snapshot audit/state evidence."""
...
SCHEMA_VERSION = 91
EVIDENCE_SCOPE = "network_snapshot_audit_state_v91"
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_AUDIT_STATE_V91_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_AUDIT_STATE_V91_VALID")
    return 0
