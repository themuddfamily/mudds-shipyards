...
try:
    from .network_snapshot_authority_provenance_v344_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_provenance_v344_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-provenance-assertion-v1", "provenance_id": "authority-provenance-v344",
        "snapshot_id": "snapshot-authority-v227", "authority": "server", "sequence": 42419,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "provenance_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 344,
        "evidence_scope": "network_snapshot_authority_provenance_v344",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "provenance_id": "authority-provenance-v344",
        "snapshot_id": "snapshot-authority-v227", "assertion_id": "authority-snapshot-provenance-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 116, "release": "release-1",
        ...
        "snapshot": {
            "provenance_id": "authority-provenance-v344", "snapshot_id": "snapshot-authority-v227",
            "assertion_id": "authority-snapshot-provenance-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 116,
            "sequence": 42419, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityProvenanceV344ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority provenance" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority provenance members" in error for error in errors))
