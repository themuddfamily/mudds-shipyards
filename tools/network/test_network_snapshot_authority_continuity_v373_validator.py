...
try:
    from .network_snapshot_authority_continuity_v373_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_continuity_v373_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-continuity-assertion-v1", "continuity_id": "authority-continuity-v373",
        "snapshot_id": "snapshot-authority-v256", "authority": "server", "sequence": 42448,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "continuity_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 373,
        "evidence_scope": "network_snapshot_authority_continuity_v373",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "continuity_id": "authority-continuity-v373",
        "snapshot_id": "snapshot-authority-v256", "assertion_id": "authority-snapshot-continuity-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 145, "release": "release-1",
        ...
        "snapshot": {
            "continuity_id": "authority-continuity-v373", "snapshot_id": "snapshot-authority-v256",
            "assertion_id": "authority-snapshot-continuity-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 145,
            "sequence": 42448, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityContinuityV373ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority continuity" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority continuity members" in error for error in errors))
