...
try:
    from .network_snapshot_attestation_lineage_v115_validator import validate_snapshot
except ImportError:
    from network_snapshot_attestation_lineage_v115_validator import validate_snapshot
...
class NetworkSnapshotAttestationLineageV115ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_attestation_binding(self):
        report = _report()
        report["records"][0]["attestation_id"] = "snapshot-attestation-v4"
    ...
    def test_rejects_lineage_binding(self):
        report = _report()
        report["records"][0]["lineage"] = "snapshot-lineage-root-v7"
        self.assertTrue(any("bind attestation/lineage" in error for error in validate_snapshot(report)))
