...
def _report():
 ...
 return{"schema_version":592,"evidence_scope":"network_snapshot_authority_evidence_confidence_v592","evidence_mode":"detached_contract_fixture","policy_version":"network_replication_interest_authority_v1","authority":"server","integrity_gate_id":"authority-evidence-confidence-v592","snapshot_id":"snapshot-authority-v475","assertion_id":"authority-snapshot-evidence-confidence-assertion-v1","source":"server_snapshot","snapshot_version":364,"release":"release-1","native_claims":False,"uses_live_network":False,"snapshot_detached":True,"no_mutation_guarantee":True,"stale_check":_nr("Detached fixture does not execute stale replay checks."),"native_run":_nr("Native transport is outside this validator scope."),"hardware_run":_nr("Hardware validation is outside this validator scope."),"human_review":_nr("Human review is outside this validator scope."),"snapshot":{"integrity_gate_id":"authority-evidence-confidence-v592","snapshot_id":"snapshot-authority-v475","assertion_id":"authority-snapshot-evidence-confidence-assertion-v1","authority":"server","source":"server_snapshot","release":"release-1","version":364,"sequence":50492,"digest":hashlib.sha256(b"snapshot").hexdigest()},"assertion_members":a,"rollup_digest":hashlib.sha256(m.encode()).hexdigest(),"counts":{"assertion_members":2,"unique":2,"asserted":2,"mutations":0}}
class NetworkSnapshotAuthorityEvidenceConfidenceV592ValidatorTest(unittest.TestCase):
