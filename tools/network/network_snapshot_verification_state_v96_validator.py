#!/usr/bin/env python3
"""Validate detached v96 snapshot verification/state evidence."""
...
SCHEMA_VERSION = 96
EVIDENCE_SCOPE = "network_snapshot_verification_state_v96"
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_VERIFICATION_STATE_V96_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_VERIFICATION_STATE_V96_VALID")
    return 0
