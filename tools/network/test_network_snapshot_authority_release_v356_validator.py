...
try:
    from .network_snapshot_authority_release_v356_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_release_v356_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-release-assertion-v1", "release_identity": "authority-release-v356",
        "snapshot_id": "snapshot-authority-v239", "authority": "server", "sequence": 42431,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "release_identity", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 356,
        "evidence_scope": "network_snapshot_authority_release_v356",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "release_identity": "authority-release-v356",
        "snapshot_id": "snapshot-authority-v239", "assertion_id": "authority-snapshot-release-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 128, "release": "release-1",
        ...
        "snapshot": {
            "release_identity": "authority-release-v356", "snapshot_id": "snapshot-authority-v239",
            "assertion_id": "authority-snapshot-release-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 128,
            "sequence": 42431, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityReleaseV356ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority release" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority release members" in error for error in errors))
