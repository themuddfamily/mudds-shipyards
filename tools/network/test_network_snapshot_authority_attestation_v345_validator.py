...
try:
    from .network_snapshot_authority_attestation_v345_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_attestation_v345_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-attestation-assertion-v1", "attestation_id": "authority-attestation-v345",
        "snapshot_id": "snapshot-authority-v228", "authority": "server", "sequence": 42420,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "attestation_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 345,
        "evidence_scope": "network_snapshot_authority_attestation_v345",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "attestation_id": "authority-attestation-v345",
        "snapshot_id": "snapshot-authority-v228", "assertion_id": "authority-snapshot-attestation-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 117, "release": "release-1",
        ...
        "snapshot": {
            "attestation_id": "authority-attestation-v345", "snapshot_id": "snapshot-authority-v228",
            "assertion_id": "authority-snapshot-attestation-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 117,
            "sequence": 42420, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityAttestationV345ValidatorTest(unittest.TestCase):
