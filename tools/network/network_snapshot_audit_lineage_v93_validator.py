#!/usr/bin/env python3
"""Validate detached v93 snapshot audit/lineage evidence."""
...
SCHEMA_VERSION = 93
EVIDENCE_SCOPE = "network_snapshot_audit_lineage_v93"
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_AUDIT_LINEAGE_V93_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_AUDIT_LINEAGE_V93_VALID")
    return 0
