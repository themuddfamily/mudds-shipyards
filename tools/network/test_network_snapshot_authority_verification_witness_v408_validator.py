...
try:
    from .network_snapshot_authority_verification_witness_v408_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_verification_witness_v408_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-verification-witness-assertion-v1",
        "integrity_gate_id": "authority-verification-witness-v408",
        "snapshot_id": "snapshot-authority-v291", "authority": "server", "sequence": 45708,
...
def _report():
    ...
    return {
        "schema_version": 408,
        "evidence_scope": "network_snapshot_authority_verification_witness_v408",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "integrity_gate_id": "authority-verification-witness-v408",
        "snapshot_id": "snapshot-authority-v291",
        "assertion_id": "authority-snapshot-verification-witness-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 180, "release": "release-1",
        ...
        "snapshot": {
            ...
            "snapshot_id": "snapshot-authority-v291",
            "assertion_id": "authority-snapshot-verification-witness-assertion-v1",
            "authority": "server", "source": "server_snapshot", "release": "release-1",
            "version": 180, "sequence": 45708,
...
class NetworkSnapshotAuthorityVerificationWitnessV408ValidatorTest(unittest.TestCase):
    def test_accepts_verification_witness_rollup(self):
        self.assertEqual(validate_snapshot(_report()), [])

    def test_rejects_verification_witness_binding(self):
        report = _report()
        report["assertion_members"][0]["snapshot_id"] = "wrong-verification"
        errors = validate_snapshot(report)
        self.assertTrue(any("bind authority verification witness" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        report["assertion_members"][0]["mutation_fields"] = ["verification"]
