#!/usr/bin/env python3
"""Validate detached v663 authority/snapshot evidence-fellowship evidence."""
from __future__ import annotations
import argparse,hashlib,json,re
from pathlib import Path
from typing import Any

SCHEMA_VERSION=663;EVIDENCE_SCOPE="network_snapshot_authority_evidence_fellowship_v663";EVIDENCE_MODE="detached_contract_fixture";POLICY_VERSION="network_replication_interest_authority_v1";AUTHORITY="server";INTEGRITY_GATE_ID="authority-evidence-fellowship-v663";SNAPSHOT_ID="snapshot-authority-v546";ASSERTION_ID="authority-snapshot-evidence-fellowship-assertion-v1";SOURCE="server_snapshot";SNAPSHOT_VERSION=435;RELEASE_ID="release-1";SHA256=re.compile(r"^[0-9a-f]{64}$");NOT_RUN_CHECKS=("stale_check","native_run","hardware_run","human_review")
...
def main()->int:
 ...
 if e:
  print("NETWORK_SNAPSHOT_AUTHORITY_EVIDENCE_FELLOWSHIP_V663_INVALID")
  for x in e:print(f"- {x}")
  return 1
 print("NETWORK_SNAPSHOT_AUTHORITY_EVIDENCE_FELLOWSHIP_V663_VALID");return 0
