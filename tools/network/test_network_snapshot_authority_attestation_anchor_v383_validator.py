...
try:
    from .network_snapshot_authority_attestation_anchor_v383_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_attestation_anchor_v383_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-attestation-anchor-assertion-v1",
        "integrity_gate_id": "authority-attestation-anchor-v383",
        "snapshot_id": "snapshot-authority-v266", "authority": "server", "sequence": 43183,
...
def _report():
    ...
    return {
        "schema_version": 383,
        "evidence_scope": "network_snapshot_authority_attestation_anchor_v383",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "integrity_gate_id": "authority-attestation-anchor-v383",
        "snapshot_id": "snapshot-authority-v266",
        "assertion_id": "authority-snapshot-attestation-anchor-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 155, "release": "release-1",
...
class NetworkSnapshotAuthorityAttestationAnchorV383ValidatorTest(unittest.TestCase):
    def test_accepts_attestation_anchor_rollup(self):
        self.assertEqual(validate_snapshot(_report()), [])

    def test_rejects_attestation_anchor_binding(self):
        report = _report()
        report["assertion_members"][0]["integrity_gate_id"] = "wrong-anchor"
        errors = validate_snapshot(report)
        self.assertTrue(any("bind authority attestation anchor" in error for error in errors))
