...
try:
    from .network_snapshot_authority_handoff_assertion_v340_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_handoff_assertion_v340_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-handoff-assertion-v1", "handoff_id": "authority-handoff-v340",
        "snapshot_id": "snapshot-authority-v223", "authority": "server", "sequence": 42415,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "handoff_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 340,
        "evidence_scope": "network_snapshot_authority_handoff_assertion_v340",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "handoff_id": "authority-handoff-v340",
        "snapshot_id": "snapshot-authority-v223", "assertion_id": "authority-snapshot-handoff-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 112, "release": "release-1",
        ...
        "snapshot": {
            "handoff_id": "authority-handoff-v340", "snapshot_id": "snapshot-authority-v223",
            "assertion_id": "authority-snapshot-handoff-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 112,
            "sequence": 42415, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityHandoffAssertionV340ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority handoff members" in error for error in errors))
