...
try:
    from .network_snapshot_authority_transition_v359_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_transition_v359_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-transition-assertion-v1", "transition_id": "authority-transition-v359",
        "snapshot_id": "snapshot-authority-v242", "authority": "server", "sequence": 42434,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "transition_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 359,
        "evidence_scope": "network_snapshot_authority_transition_v359",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "transition_id": "authority-transition-v359",
        "snapshot_id": "snapshot-authority-v242", "assertion_id": "authority-snapshot-transition-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 131, "release": "release-1",
        ...
        "snapshot": {
            "transition_id": "authority-transition-v359", "snapshot_id": "snapshot-authority-v242",
            "assertion_id": "authority-snapshot-transition-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 131,
            "sequence": 42434, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityTransitionV359ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority transition" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority transition members" in error for error in errors))
