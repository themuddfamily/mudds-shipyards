...
try:
    from .network_snapshot_authority_governance_v369_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_governance_v369_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-governance-assertion-v1", "governance_id": "authority-governance-v369",
        "snapshot_id": "snapshot-authority-v252", "authority": "server", "sequence": 42444,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "governance_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 369,
        "evidence_scope": "network_snapshot_authority_governance_v369",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "governance_id": "authority-governance-v369",
        "snapshot_id": "snapshot-authority-v252", "assertion_id": "authority-snapshot-governance-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 141, "release": "release-1",
        ...
        "snapshot": {
            "governance_id": "authority-governance-v369", "snapshot_id": "snapshot-authority-v252",
            "assertion_id": "authority-snapshot-governance-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 141,
            "sequence": 42444, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityGovernanceV369ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority governance" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority governance members" in error for error in errors))
