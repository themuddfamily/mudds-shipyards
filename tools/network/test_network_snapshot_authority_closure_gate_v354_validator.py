...
try:
    from .network_snapshot_authority_closure_gate_v354_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_closure_gate_v354_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-closure-gate-assertion-v1", "closure_gate_id": "authority-closure-gate-v354",
        "snapshot_id": "snapshot-authority-v237", "authority": "server", "sequence": 42429,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "closure_gate_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 354,
        "evidence_scope": "network_snapshot_authority_closure_gate_v354",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "closure_gate_id": "authority-closure-gate-v354",
        "snapshot_id": "snapshot-authority-v237", "assertion_id": "authority-snapshot-closure-gate-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 126, "release": "release-1",
        ...
        "snapshot": {
            "closure_gate_id": "authority-closure-gate-v354", "snapshot_id": "snapshot-authority-v237",
            "assertion_id": "authority-snapshot-closure-gate-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 126,
            "sequence": 42429, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityClosureGateV354ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority closure gate" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority closure gate members" in error for error in errors))
