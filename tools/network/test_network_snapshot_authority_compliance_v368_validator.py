...
try:
    from .network_snapshot_authority_compliance_v368_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_compliance_v368_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-compliance-assertion-v1", "compliance_id": "authority-compliance-v368",
        "snapshot_id": "snapshot-authority-v251", "authority": "server", "sequence": 42443,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "compliance_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 368,
        "evidence_scope": "network_snapshot_authority_compliance_v368",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "compliance_id": "authority-compliance-v368",
        "snapshot_id": "snapshot-authority-v251", "assertion_id": "authority-snapshot-compliance-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 140, "release": "release-1",
        ...
        "snapshot": {
            "compliance_id": "authority-compliance-v368", "snapshot_id": "snapshot-authority-v251",
            "assertion_id": "authority-snapshot-compliance-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 140,
            "sequence": 42443, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityComplianceV368ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority compliance" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority compliance members" in error for error in errors))
