...
try:
    from .network_snapshot_authority_recovery_v372_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_recovery_v372_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-recovery-assertion-v1", "recovery_id": "authority-recovery-v372",
        "snapshot_id": "snapshot-authority-v255", "authority": "server", "sequence": 42447,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "recovery_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 372,
        "evidence_scope": "network_snapshot_authority_recovery_v372",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "recovery_id": "authority-recovery-v372",
        "snapshot_id": "snapshot-authority-v255", "assertion_id": "authority-snapshot-recovery-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 144, "release": "release-1",
        ...
        "snapshot": {
            "recovery_id": "authority-recovery-v372", "snapshot_id": "snapshot-authority-v255",
            "assertion_id": "authority-snapshot-recovery-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 144,
            "sequence": 42447, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityRecoveryV372ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority recovery" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority recovery members" in error for error in errors))
