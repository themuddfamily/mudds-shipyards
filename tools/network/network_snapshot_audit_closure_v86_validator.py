#!/usr/bin/env python3
"""Validate detached v86 snapshot audit/closure evidence."""
...
SCHEMA_VERSION = 86
EVIDENCE_SCOPE = "network_snapshot_audit_closure_v86"
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_AUDIT_CLOSURE_V86_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_AUDIT_CLOSURE_V86_VALID")
    return 0
