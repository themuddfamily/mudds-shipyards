...
try:
    from .network_snapshot_authority_provenance_seal_v377_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_provenance_seal_v377_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-provenance-seal-assertion-v1",
        "integrity_gate_id": "authority-provenance-seal-v377",
        "snapshot_id": "snapshot-authority-v260", "authority": "server", "sequence": 42677,
...
def _report():
    ...
    return {
        "schema_version": 377,
        "evidence_scope": "network_snapshot_authority_provenance_seal_v377",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "integrity_gate_id": "authority-provenance-seal-v377",
        "snapshot_id": "snapshot-authority-v260",
        "assertion_id": "authority-snapshot-provenance-seal-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 149, "release": "release-1",
...
class NetworkSnapshotAuthorityProvenanceSealV377ValidatorTest(unittest.TestCase):
    def test_accepts_provenance_rollup(self):
        self.assertEqual(validate_snapshot(_report()), [])

    def test_rejects_provenance_binding(self):
        report = _report()
        report["assertion_members"][0]["integrity_gate_id"] = "wrong-seal"
        errors = validate_snapshot(report)
        self.assertTrue(any("bind authority provenance seal" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        report["assertion_members"][0]["mutation_fields"] = ["snapshot"]
