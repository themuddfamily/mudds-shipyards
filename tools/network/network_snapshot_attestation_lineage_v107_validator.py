#!/usr/bin/env python3
"""Validate detached v107 snapshot attestation/lineage evidence."""
...
SCHEMA_VERSION = 107
EVIDENCE_SCOPE = "network_snapshot_attestation_lineage_v107"
EVIDENCE_MODE = "detached_contract_fixture"
POLICY_VERSION = "network_replication_interest_authority_v1"
AUTHORITY = "server"
ATTESTATION_ID = "snapshot-attestation-v4"
LINEAGE = "snapshot-lineage-root-v5"
...
def _attestation_digest(record: dict[str, Any]) -> str:
    fields = (
        "authority", "attestation_id", "lineage", "source", "release", "version",
...
def validate_snapshot(report: Any, label: str = "snapshot") -> list[str]:
    """Return errors for detached attestation/lineage snapshot evidence."""
    errors: list[str] = []
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_ATTESTATION_LINEAGE_V107_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_ATTESTATION_LINEAGE_V107_VALID")
    return 0
