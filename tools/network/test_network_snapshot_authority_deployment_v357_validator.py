...
try:
    from .network_snapshot_authority_deployment_v357_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_deployment_v357_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-deployment-assertion-v1", "deployment_id": "authority-deployment-v357",
        "snapshot_id": "snapshot-authority-v240", "authority": "server", "sequence": 42432,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "deployment_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 357,
        "evidence_scope": "network_snapshot_authority_deployment_v357",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "deployment_id": "authority-deployment-v357",
        "snapshot_id": "snapshot-authority-v240", "assertion_id": "authority-snapshot-deployment-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 129, "release": "release-1",
        ...
        "snapshot": {
            "deployment_id": "authority-deployment-v357", "snapshot_id": "snapshot-authority-v240",
            "assertion_id": "authority-snapshot-deployment-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 129,
            "sequence": 42432, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityDeploymentV357ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority deployment" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority deployment members" in error for error in errors))
