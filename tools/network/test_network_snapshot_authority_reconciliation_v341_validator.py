...
try:
    from .network_snapshot_authority_reconciliation_v341_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_reconciliation_v341_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-reconciliation-assertion-v1", "reconciliation_id": "authority-reconciliation-v341",
        "snapshot_id": "snapshot-authority-v224", "authority": "server", "sequence": 42416,
...
def _report():
    ...
    return {
        "schema_version": 341,
        "evidence_scope": "network_snapshot_authority_reconciliation_v341",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "reconciliation_id": "authority-reconciliation-v341",
        "snapshot_id": "snapshot-authority-v224", "assertion_id": "authority-snapshot-reconciliation-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 113, "release": "release-1",
        ...
        "snapshot": {
            "reconciliation_id": "authority-reconciliation-v341", "snapshot_id": "snapshot-authority-v224",
            "assertion_id": "authority-snapshot-reconciliation-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 113,
            "sequence": 42416, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityReconciliationV341ValidatorTest(unittest.TestCase):
