...
try:
    from .network_snapshot_authority_evidence_v363_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_evidence_v363_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-evidence-assertion-v1", "evidence_id": "authority-evidence-v363",
        "snapshot_id": "snapshot-authority-v246", "authority": "server", "sequence": 42438,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "evidence_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 363,
        "evidence_scope": "network_snapshot_authority_evidence_v363",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "evidence_id": "authority-evidence-v363",
        "snapshot_id": "snapshot-authority-v246", "assertion_id": "authority-snapshot-evidence-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 135, "release": "release-1",
        ...
        "snapshot": {
            "evidence_id": "authority-evidence-v363", "snapshot_id": "snapshot-authority-v246",
            "assertion_id": "authority-snapshot-evidence-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 135,
            "sequence": 42438, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityEvidenceV363ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority evidence" in error for error in errors))
