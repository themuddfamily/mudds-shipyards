...
try:
    from .network_snapshot_authority_integrity_gate_v375_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_integrity_gate_v375_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-integrity-gate-assertion-v1", "integrity_gate_id": "authority-integrity-gate-v375",
        "snapshot_id": "snapshot-authority-v258", "authority": "server", "sequence": 42450,
...
def _report():
    ...
    return {
        "schema_version": 375,
        "evidence_scope": "network_snapshot_authority_integrity_gate_v375",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "integrity_gate_id": "authority-integrity-gate-v375",
        "snapshot_id": "snapshot-authority-v258", "assertion_id": "authority-snapshot-integrity-gate-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 147, "release": "release-1",
        ...
        "snapshot": {
            "integrity_gate_id": "authority-integrity-gate-v375", "snapshot_id": "snapshot-authority-v258",
            "assertion_id": "authority-snapshot-integrity-gate-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 147,
            "sequence": 42450, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityIntegrityGateV375ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority integrity gate" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority integrity gate members" in error for error in errors))
