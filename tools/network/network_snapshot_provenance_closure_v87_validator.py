#!/usr/bin/env python3
"""Validate detached v87 snapshot provenance/closure evidence."""
...
SCHEMA_VERSION = 87
EVIDENCE_SCOPE = "network_snapshot_provenance_closure_v87"
EVIDENCE_MODE = "detached_contract_fixture"
POLICY_VERSION = "network_replication_interest_authority_v1"
AUTHORITY = "server"
PROVENANCE = "server_snapshot_fixture_v2"
CLOSURE = "closed"
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_PROVENANCE_CLOSURE_V87_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_PROVENANCE_CLOSURE_V87_VALID")
    return 0
