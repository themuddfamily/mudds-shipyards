#!/usr/bin/env python3
"""Validate detached v147 network snapshot authority-attestation evidence."""
...
SCHEMA_VERSION = 147
EVIDENCE_SCOPE = "network_snapshot_authority_attestation_v147"
EVIDENCE_MODE = "detached_contract_fixture"
POLICY_VERSION = "network_replication_interest_authority_v1"
AUTHORITY = "server"
AUTHORITY_ATTESTATION = "server-authority-attestation-v1"
SNAPSHOT_ID = "snapshot-authority-v30"
...
def validate_snapshot(report: Any, label: str = "snapshot") -> list[str]:
    ...
    for index, record in enumerate(records):
        ...
        if not _digest(binding_digest):
            ...
            errors.append(f"{prefix}.binding_digest must bind authority attestation")
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_AUTHORITY_ATTESTATION_V147_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_AUTHORITY_ATTESTATION_V147_VALID")
    return 0
