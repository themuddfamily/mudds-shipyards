...
try:
    from .network_snapshot_authority_coverage_v352_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_coverage_v352_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-coverage-assertion-v1", "coverage_id": "authority-coverage-v352",
        "snapshot_id": "snapshot-authority-v235", "authority": "server", "sequence": 42427,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "coverage_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 352,
        "evidence_scope": "network_snapshot_authority_coverage_v352",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "coverage_id": "authority-coverage-v352",
        "snapshot_id": "snapshot-authority-v235", "assertion_id": "authority-snapshot-coverage-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 124, "release": "release-1",
        ...
        "snapshot": {
            "coverage_id": "authority-coverage-v352", "snapshot_id": "snapshot-authority-v235",
            "assertion_id": "authority-snapshot-coverage-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 124,
            "sequence": 42427, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityCoverageV352ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority coverage" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority coverage members" in error for error in errors))
