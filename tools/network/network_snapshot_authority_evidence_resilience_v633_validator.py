#!/usr/bin/env python3
"""Validate detached v633 authority/snapshot evidence-resilience evidence."""
from __future__ import annotations
import argparse,hashlib,json,re
from pathlib import Path
from typing import Any

SCHEMA_VERSION=633;EVIDENCE_SCOPE="network_snapshot_authority_evidence_resilience_v633";EVIDENCE_MODE="detached_contract_fixture";POLICY_VERSION="network_replication_interest_authority_v1";AUTHORITY="server";INTEGRITY_GATE_ID="authority-evidence-resilience-v633";SNAPSHOT_ID="snapshot-authority-v516";ASSERTION_ID="authority-snapshot-evidence-resilience-assertion-v1";SOURCE="server_snapshot";SNAPSHOT_VERSION=405;RELEASE_ID="release-1";SHA256=re.compile(r"^[0-9a-f]{64}$");NOT_RUN_CHECKS=("stale_check","native_run","hardware_run","human_review")
...
def main()->int:
 ...
 if e:
  print("NETWORK_SNAPSHOT_AUTHORITY_EVIDENCE_RESILIENCE_V633_INVALID")
  for x in e:print(f"- {x}")
  return 1
 print("NETWORK_SNAPSHOT_AUTHORITY_EVIDENCE_RESILIENCE_V633_VALID");return 0
