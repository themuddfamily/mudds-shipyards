...
try:
    from .network_snapshot_authority_verification_v346_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_verification_v346_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-verification-assertion-v1", "verification_id": "authority-verification-v346",
        "snapshot_id": "snapshot-authority-v229", "authority": "server", "sequence": 42421,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "verification_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 346,
        "evidence_scope": "network_snapshot_authority_verification_v346",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "verification_id": "authority-verification-v346",
        "snapshot_id": "snapshot-authority-v229", "assertion_id": "authority-snapshot-verification-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 118, "release": "release-1",
        ...
        "snapshot": {
            "verification_id": "authority-verification-v346", "snapshot_id": "snapshot-authority-v229",
            "assertion_id": "authority-snapshot-verification-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 118,
            "sequence": 42421, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityVerificationV346ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority verification" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority verification members" in error for error in errors))
