#!/usr/bin/env python3
"""Validate detached v361 authority/snapshot reconciliation evidence."""
...
AUTHORITY = "server"
RECONCILIATION_ID = "authority-reconciliation-v361"
SNAPSHOT_ID = "snapshot-authority-v244"
ASSERTION_ID = "authority-snapshot-reconciliation-assertion-v1"
SOURCE = "server_snapshot"
SNAPSHOT_VERSION = 133
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_AUTHORITY_RECONCILIATION_V361_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_AUTHORITY_RECONCILIATION_V361_VALID")
    return 0
