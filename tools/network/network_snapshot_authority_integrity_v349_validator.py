#!/usr/bin/env python3
"""Validate detached v349 authority/snapshot integrity evidence."""
...
AUTHORITY = "server"
INTEGRITY_ID = "authority-integrity-v349"
SNAPSHOT_ID = "snapshot-authority-v232"
ASSERTION_ID = "authority-snapshot-integrity-assertion-v1"
SOURCE = "server_snapshot"
SNAPSHOT_VERSION = 121
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_AUTHORITY_INTEGRITY_V349_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_AUTHORITY_INTEGRITY_V349_VALID")
    return 0
