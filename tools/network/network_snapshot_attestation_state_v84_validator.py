#!/usr/bin/env python3
"""Validate detached v84 snapshot attestation/state evidence."""
...
SCHEMA_VERSION = 84
EVIDENCE_SCOPE = "network_snapshot_attestation_state_v84"
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_ATTESTATION_STATE_V84_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_ATTESTATION_STATE_V84_VALID")
    return 0
