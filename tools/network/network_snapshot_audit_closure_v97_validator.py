#!/usr/bin/env python3
"""Validate detached v97 snapshot audit/closure evidence."""
...
SCHEMA_VERSION = 97
EVIDENCE_SCOPE = "network_snapshot_audit_closure_v97"
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_AUDIT_CLOSURE_V97_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_AUDIT_CLOSURE_V97_VALID")
    return 0
