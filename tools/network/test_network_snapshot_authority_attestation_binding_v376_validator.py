...
try:
    from .network_snapshot_authority_attestation_binding_v376_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_attestation_binding_v376_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "snapshot_id": "snapshot-authority-v259", "authority": "server", "sequence": 42576,
...
def _report():
    ...
    return {
        ...
        "authority": "server", "integrity_gate_id": "authority-attestation-binding-v376",
        "snapshot_id": "snapshot-authority-v259",
        "assertion_id": "authority-snapshot-attestation-binding-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 148, "release": "release-1",
...
class NetworkSnapshotAuthorityAttestationBindingV376ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_attestation_binding(self):
        report = _report()
        report["assertion_members"][0]["snapshot_id"] = "wrong-snapshot"
