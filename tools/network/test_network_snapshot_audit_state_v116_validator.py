...
try:
    from .network_snapshot_audit_state_v116_validator import validate_snapshot
except ImportError:
    from network_snapshot_audit_state_v116_validator import validate_snapshot
