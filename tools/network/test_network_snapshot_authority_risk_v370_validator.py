...
try:
    from .network_snapshot_authority_risk_v370_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_risk_v370_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-risk-assertion-v1", "risk_id": "authority-risk-v370",
        "snapshot_id": "snapshot-authority-v253", "authority": "server", "sequence": 42445,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "risk_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 370,
        "evidence_scope": "network_snapshot_authority_risk_v370",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "risk_id": "authority-risk-v370",
        "snapshot_id": "snapshot-authority-v253", "assertion_id": "authority-snapshot-risk-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 142, "release": "release-1",
        ...
        "snapshot": {
            "risk_id": "authority-risk-v370", "snapshot_id": "snapshot-authority-v253",
            "assertion_id": "authority-snapshot-risk-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 142,
            "sequence": 42445, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityRiskV370ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority risk" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority risk members" in error for error in errors))
