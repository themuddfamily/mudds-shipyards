...
try:
    from .network_snapshot_authority_reconciliation_v361_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_reconciliation_v361_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-reconciliation-assertion-v1", "reconciliation_id": "authority-reconciliation-v361",
        "snapshot_id": "snapshot-authority-v244", "authority": "server", "sequence": 42436,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "reconciliation_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 361,
        "evidence_scope": "network_snapshot_authority_reconciliation_v361",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "reconciliation_id": "authority-reconciliation-v361",
        "snapshot_id": "snapshot-authority-v244", "assertion_id": "authority-snapshot-reconciliation-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 133, "release": "release-1",
        ...
        "snapshot": {
            "reconciliation_id": "authority-reconciliation-v361", "snapshot_id": "snapshot-authority-v244",
            "assertion_id": "authority-snapshot-reconciliation-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 133,
            "sequence": 42436, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityReconciliationV361ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority reconciliation members" in error for error in errors))
