...
try:
    from .network_snapshot_authority_takeover_assertion_v339_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_takeover_assertion_v339_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-assertion-v1", "takeover_id": "authority-takeover-v339",
        "snapshot_id": "snapshot-authority-v222", "authority": "server", "sequence": 42414,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "takeover_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 339,
        "evidence_scope": "network_snapshot_authority_takeover_assertion_v339",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "takeover_id": "authority-takeover-v339",
        "snapshot_id": "snapshot-authority-v222", "assertion_id": "authority-snapshot-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 111, "release": "release-1",
        ...
        "snapshot": {
            "takeover_id": "authority-takeover-v339", "snapshot_id": "snapshot-authority-v222",
            "assertion_id": "authority-snapshot-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 111,
            "sequence": 42414, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityTakeoverAssertionV339ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority assertion members" in error for error in errors))
