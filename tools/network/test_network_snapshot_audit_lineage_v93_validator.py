...
try:
    from .network_snapshot_audit_lineage_v93_validator import validate_snapshot
except ImportError:
    from network_snapshot_audit_lineage_v93_validator import validate_snapshot
...
def _report():
    ...
    return {
        "schema_version": 93, "evidence_scope": "network_snapshot_audit_lineage_v93", "evidence_mode": "detached_contract_fixture", "policy_version": "network_replication_interest_authority_v1",
...
class NetworkSnapshotAuditLineageV93ValidatorTest(unittest.TestCase):
