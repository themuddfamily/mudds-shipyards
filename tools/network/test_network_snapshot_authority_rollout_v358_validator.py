...
try:
    from .network_snapshot_authority_rollout_v358_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_rollout_v358_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-rollout-assertion-v1", "rollout_id": "authority-rollout-v358",
        "snapshot_id": "snapshot-authority-v241", "authority": "server", "sequence": 42433,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "rollout_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 358,
        "evidence_scope": "network_snapshot_authority_rollout_v358",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "rollout_id": "authority-rollout-v358",
        "snapshot_id": "snapshot-authority-v241", "assertion_id": "authority-snapshot-rollout-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 130, "release": "release-1",
        ...
        "snapshot": {
            "rollout_id": "authority-rollout-v358", "snapshot_id": "snapshot-authority-v241",
            "assertion_id": "authority-snapshot-rollout-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 130,
            "sequence": 42433, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityRolloutV358ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority rollout" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority rollout members" in error for error in errors))
