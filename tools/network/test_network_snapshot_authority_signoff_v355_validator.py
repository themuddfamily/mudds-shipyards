...
try:
    from .network_snapshot_authority_signoff_v355_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_signoff_v355_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-signoff-assertion-v1", "signoff_id": "authority-signoff-v355",
        "snapshot_id": "snapshot-authority-v238", "authority": "server", "sequence": 42430,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "signoff_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 355,
        "evidence_scope": "network_snapshot_authority_signoff_v355",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "signoff_id": "authority-signoff-v355",
        "snapshot_id": "snapshot-authority-v238", "assertion_id": "authority-snapshot-signoff-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 127, "release": "release-1",
        ...
        "snapshot": {
            "signoff_id": "authority-signoff-v355", "snapshot_id": "snapshot-authority-v238",
            "assertion_id": "authority-snapshot-signoff-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 127,
            "sequence": 42430, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthoritySignoffV355ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority signoff" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority signoff members" in error for error in errors))
