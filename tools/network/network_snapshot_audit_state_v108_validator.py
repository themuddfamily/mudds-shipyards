#!/usr/bin/env python3
"""Validate detached v108 snapshot audit/state evidence."""
...
SCHEMA_VERSION = 108
EVIDENCE_SCOPE = "network_snapshot_audit_state_v108"
EVIDENCE_MODE = "detached_contract_fixture"
POLICY_VERSION = "network_replication_interest_authority_v1"
AUTHORITY = "server"
AUDIT_ID = "snapshot-audit-v5"
STATE = "stable"
...
def _audit_digest(record: dict[str, Any]) -> str:
    fields = (
        "authority", "audit_id", "state", "source", "release", "version",
...
def validate_snapshot(report: Any, label: str = "snapshot") -> list[str]:
    """Return errors for detached audit/state snapshot evidence."""
    errors: list[str] = []
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_AUDIT_STATE_V108_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_AUDIT_STATE_V108_VALID")
    return 0
