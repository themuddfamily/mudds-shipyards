...
try:
    from .network_snapshot_authority_validation_v362_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_validation_v362_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-validation-assertion-v1", "validation_id": "authority-validation-v362",
        "snapshot_id": "snapshot-authority-v245", "authority": "server", "sequence": 42437,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "validation_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 362,
        "evidence_scope": "network_snapshot_authority_validation_v362",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "validation_id": "authority-validation-v362",
        "snapshot_id": "snapshot-authority-v245", "assertion_id": "authority-snapshot-validation-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 134, "release": "release-1",
        ...
        "snapshot": {
            "validation_id": "authority-validation-v362", "snapshot_id": "snapshot-authority-v245",
            "assertion_id": "authority-snapshot-validation-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 134,
            "sequence": 42437, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityValidationV362ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority validation" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority validation members" in error for error in errors))
