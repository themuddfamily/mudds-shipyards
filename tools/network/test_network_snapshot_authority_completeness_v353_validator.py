...
try:
    from .network_snapshot_authority_completeness_v353_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_completeness_v353_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-completeness-assertion-v1", "completeness_id": "authority-completeness-v353",
        "snapshot_id": "snapshot-authority-v236", "authority": "server", "sequence": 42428,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "completeness_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 353,
        "evidence_scope": "network_snapshot_authority_completeness_v353",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "completeness_id": "authority-completeness-v353",
        "snapshot_id": "snapshot-authority-v236", "assertion_id": "authority-snapshot-completeness-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 125, "release": "release-1",
        ...
        "snapshot": {
            "completeness_id": "authority-completeness-v353", "snapshot_id": "snapshot-authority-v236",
            "assertion_id": "authority-snapshot-completeness-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 125,
            "sequence": 42428, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityCompletenessV353ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority completeness" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority completeness members" in error for error in errors))
