#!/usr/bin/env python3
"""Validate detached v659 authority/snapshot evidence-harmony evidence."""
from __future__ import annotations
import argparse,hashlib,json,re
from pathlib import Path
from typing import Any

SCHEMA_VERSION=659;EVIDENCE_SCOPE="network_snapshot_authority_evidence_harmony_v659";EVIDENCE_MODE="detached_contract_fixture";POLICY_VERSION="network_replication_interest_authority_v1";AUTHORITY="server";INTEGRITY_GATE_ID="authority-evidence-harmony-v659";SNAPSHOT_ID="snapshot-authority-v542";ASSERTION_ID="authority-snapshot-evidence-harmony-assertion-v1";SOURCE="server_snapshot";SNAPSHOT_VERSION=431;RELEASE_ID="release-1";SHA256=re.compile(r"^[0-9a-f]{64}$");NOT_RUN_CHECKS=("stale_check","native_run","hardware_run","human_review")
...
def main()->int:
 ...
 if e:
  print("NETWORK_SNAPSHOT_AUTHORITY_EVIDENCE_HARMONY_V659_INVALID")
  for x in e:print(f"- {x}")
  return 1
 print("NETWORK_SNAPSHOT_AUTHORITY_EVIDENCE_HARMONY_V659_VALID");return 0
