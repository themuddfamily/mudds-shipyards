...
try:
    from .network_snapshot_authority_closure_v342_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_closure_v342_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-closure-assertion-v1", "closure_id": "authority-closure-v342",
        "snapshot_id": "snapshot-authority-v225", "authority": "server", "sequence": 42417,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "closure_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 342,
        "evidence_scope": "network_snapshot_authority_closure_v342",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "closure_id": "authority-closure-v342",
        "snapshot_id": "snapshot-authority-v225", "assertion_id": "authority-snapshot-closure-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 114, "release": "release-1",
        ...
        "snapshot": {
            "closure_id": "authority-closure-v342", "snapshot_id": "snapshot-authority-v225",
            "assertion_id": "authority-snapshot-closure-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 114,
            "sequence": 42417, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityClosureV342ValidatorTest(unittest.TestCase):
