...
try:
    from .network_snapshot_authority_observability_v366_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_observability_v366_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-observability-assertion-v1", "observability_id": "authority-observability-v366",
        "snapshot_id": "snapshot-authority-v249", "authority": "server", "sequence": 42441,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "observability_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 366,
        "evidence_scope": "network_snapshot_authority_observability_v366",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "observability_id": "authority-observability-v366",
        "snapshot_id": "snapshot-authority-v249", "assertion_id": "authority-snapshot-observability-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 138, "release": "release-1",
        ...
        "snapshot": {
            "observability_id": "authority-observability-v366", "snapshot_id": "snapshot-authority-v249",
            "assertion_id": "authority-snapshot-observability-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 138,
            "sequence": 42441, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityObservabilityV366ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority observability" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority observability members" in error for error in errors))
