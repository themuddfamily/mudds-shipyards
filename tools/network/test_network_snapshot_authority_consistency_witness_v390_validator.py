...
try:
    from .network_snapshot_authority_consistency_witness_v390_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_consistency_witness_v390_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-consistency-witness-assertion-v1",
        "integrity_gate_id": "authority-consistency-witness-v390",
        "snapshot_id": "snapshot-authority-v273", "authority": "server", "sequence": 43890,
...
def _report():
    ...
    return {
        "schema_version": 390,
        "evidence_scope": "network_snapshot_authority_consistency_witness_v390",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "integrity_gate_id": "authority-consistency-witness-v390",
        "snapshot_id": "snapshot-authority-v273",
        "assertion_id": "authority-snapshot-consistency-witness-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 162, "release": "release-1",
...
class NetworkSnapshotAuthorityConsistencyWitnessV390ValidatorTest(unittest.TestCase):
    def test_accepts_consistency_witness_rollup(self):
        self.assertEqual(validate_snapshot(_report()), [])

    def test_rejects_consistency_witness_binding(self):
        report = _report()
        report["assertion_members"][0]["snapshot_id"] = "wrong-consistency"
        errors = validate_snapshot(report)
        self.assertTrue(any("bind authority consistency witness" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        report["assertion_members"][0]["state_changed"] = True
