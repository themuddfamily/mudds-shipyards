#!/usr/bin/env python3
"""Validate detached v115 snapshot attestation/lineage evidence."""
...
SCHEMA_VERSION = 115
EVIDENCE_SCOPE = "network_snapshot_attestation_lineage_v115"
EVIDENCE_MODE = "detached_contract_fixture"
POLICY_VERSION = "network_replication_interest_authority_v1"
AUTHORITY = "server"
ATTESTATION_ID = "snapshot-attestation-v5"
LINEAGE = "snapshot-lineage-root-v8"
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_ATTESTATION_LINEAGE_V115_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_ATTESTATION_LINEAGE_V115_VALID")
    return 0
