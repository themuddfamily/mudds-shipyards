#!/usr/bin/env python3
"""Validate detached v101 snapshot evidence/closure evidence."""
...
SCHEMA_VERSION = 101
EVIDENCE_SCOPE = "network_snapshot_evidence_closure_v101"
...
def main() -> int:
    ...
    if errors:
        print("NETWORK_SNAPSHOT_EVIDENCE_CLOSURE_V101_INVALID")
        for error in errors:
            print(f"- {error}")
        return 1
    print("NETWORK_SNAPSHOT_EVIDENCE_CLOSURE_V101_VALID")
    return 0
