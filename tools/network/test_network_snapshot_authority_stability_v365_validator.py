...
try:
    from .network_snapshot_authority_stability_v365_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_stability_v365_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-stability-assertion-v1", "stability_id": "authority-stability-v365",
        "snapshot_id": "snapshot-authority-v248", "authority": "server", "sequence": 42440,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "stability_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 365,
        "evidence_scope": "network_snapshot_authority_stability_v365",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "stability_id": "authority-stability-v365",
        "snapshot_id": "snapshot-authority-v248", "assertion_id": "authority-snapshot-stability-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 137, "release": "release-1",
        ...
        "snapshot": {
            "stability_id": "authority-stability-v365", "snapshot_id": "snapshot-authority-v248",
            "assertion_id": "authority-snapshot-stability-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 137,
            "sequence": 42440, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityStabilityV365ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority stability" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority stability members" in error for error in errors))
