...
try:
    from .network_snapshot_release_version_reconciliation_v53_validator import validate_checks
except ImportError:
    from network_snapshot_release_version_reconciliation_v53_validator import validate_checks
...
class NetworkSnapshotReleaseVersionReconciliationV53ValidatorTest(unittest.TestCase):
    def test_accepts_reconciliations(self):
    ...
    def test_rejects_aggregate_digest(self):
        ...
        self.assertTrue(any("match reconciliations" in error for error in validate_checks(report)))
