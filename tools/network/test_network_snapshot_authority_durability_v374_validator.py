...
try:
    from .network_snapshot_authority_durability_v374_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_durability_v374_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-durability-assertion-v1", "durability_id": "authority-durability-v374",
        "snapshot_id": "snapshot-authority-v257", "authority": "server", "sequence": 42449,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "durability_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 374,
        "evidence_scope": "network_snapshot_authority_durability_v374",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "durability_id": "authority-durability-v374",
        "snapshot_id": "snapshot-authority-v257", "assertion_id": "authority-snapshot-durability-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 146, "release": "release-1",
        ...
        "snapshot": {
            "durability_id": "authority-durability-v374", "snapshot_id": "snapshot-authority-v257",
            "assertion_id": "authority-snapshot-durability-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 146,
            "sequence": 42449, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityDurabilityV374ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority durability" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority durability members" in error for error in errors))
