...
try:
    from .network_snapshot_authority_lineage_v343_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_lineage_v343_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-lineage-assertion-v1", "lineage_id": "authority-lineage-v343",
        "snapshot_id": "snapshot-authority-v226", "authority": "server", "sequence": 42418,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "lineage_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 343,
        "evidence_scope": "network_snapshot_authority_lineage_v343",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "lineage_id": "authority-lineage-v343",
        "snapshot_id": "snapshot-authority-v226", "assertion_id": "authority-snapshot-lineage-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 115, "release": "release-1",
        ...
        "snapshot": {
            "lineage_id": "authority-lineage-v343", "snapshot_id": "snapshot-authority-v226",
            "assertion_id": "authority-snapshot-lineage-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 115,
            "sequence": 42418, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityLineageV343ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority lineage members" in error for error in errors))
