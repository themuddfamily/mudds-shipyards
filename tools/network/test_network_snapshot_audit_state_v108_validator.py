...
try:
    from .network_snapshot_audit_state_v108_validator import validate_snapshot
except ImportError:
    from network_snapshot_audit_state_v108_validator import validate_snapshot
