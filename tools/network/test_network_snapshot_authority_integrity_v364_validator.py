...
try:
    from .network_snapshot_authority_integrity_v364_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_integrity_v364_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-integrity-assertion-v1", "integrity_id": "authority-integrity-v364",
        "snapshot_id": "snapshot-authority-v247", "authority": "server", "sequence": 42439,
        "subject": subject, "authority_digest": digest, "snapshot_digest": digest,
        "asserted": True, "mutation_fields": [], "state_changed": False,
    }
    fields = (
        "assertion_id", "integrity_id", "snapshot_id", "sequence", "subject",
...
def _report():
    ...
    return {
        "schema_version": 364,
        "evidence_scope": "network_snapshot_authority_integrity_v364",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "integrity_id": "authority-integrity-v364",
        "snapshot_id": "snapshot-authority-v247", "assertion_id": "authority-snapshot-integrity-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 136, "release": "release-1",
        ...
        "snapshot": {
            "integrity_id": "authority-integrity-v364", "snapshot_id": "snapshot-authority-v247",
            "assertion_id": "authority-snapshot-integrity-assertion-v1", "authority": "server",
            "source": "server_snapshot", "release": "release-1", "version": 136,
            "sequence": 42439, "digest": hashlib.sha256(b"snapshot").hexdigest(),
        },
...
class NetworkSnapshotAuthorityIntegrityV364ValidatorTest(unittest.TestCase):
    ...
    def test_rejects_assertion_binding(self):
        ...
        self.assertTrue(any("bind authority integrity" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        errors = validate_snapshot(report)
        self.assertTrue(any("match authority integrity members" in error for error in errors))
