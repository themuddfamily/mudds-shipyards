...
try:
    from .network_snapshot_channel_release_reconciliation_v56_validator import validate_checks
except ImportError:
    from network_snapshot_channel_release_reconciliation_v56_validator import validate_checks
...
def _report():
    ...
    return {
        "schema_version": 56, "evidence_scope": "network_snapshot_channel_release_reconciliation_v56",
...
class NetworkSnapshotChannelReleaseReconciliationV56ValidatorTest(unittest.TestCase):
