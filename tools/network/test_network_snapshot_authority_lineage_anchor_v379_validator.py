...
try:
    from .network_snapshot_authority_lineage_anchor_v379_validator import validate_snapshot
except ImportError:
    from network_snapshot_authority_lineage_anchor_v379_validator import validate_snapshot
...
def _item(order, item_id, digest, subject):
    item = {
        ...
        "assertion_id": "authority-snapshot-lineage-anchor-assertion-v1",
        "integrity_gate_id": "authority-lineage-anchor-v379",
        "snapshot_id": "snapshot-authority-v262", "authority": "server", "sequence": 42779,
...
def _report():
    ...
    return {
        "schema_version": 379,
        "evidence_scope": "network_snapshot_authority_lineage_anchor_v379",
        "evidence_mode": "detached_contract_fixture",
        "policy_version": "network_replication_interest_authority_v1",
        "authority": "server", "integrity_gate_id": "authority-lineage-anchor-v379",
        "snapshot_id": "snapshot-authority-v262",
        "assertion_id": "authority-snapshot-lineage-anchor-assertion-v1",
        "source": "server_snapshot", "snapshot_version": 151, "release": "release-1",
...
class NetworkSnapshotAuthorityLineageAnchorV379ValidatorTest(unittest.TestCase):
    def test_accepts_lineage_anchor_rollup(self):
        self.assertEqual(validate_snapshot(_report()), [])

    def test_rejects_lineage_anchor_binding(self):
        report = _report()
        report["assertion_members"][0]["snapshot_id"] = "wrong-anchor"
        errors = validate_snapshot(report)
        self.assertTrue(any("bind authority lineage anchor" in error for error in errors))
    ...
    def test_rejects_rollup_and_mutation(self):
        ...
        report["assertion_members"][0]["mutation_fields"] = ["lineage"]
