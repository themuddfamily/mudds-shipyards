#!/usr/bin/env python3
"""Validate v92 attestation/state summaries."""
...
SCHEMA = "audio_cleanup_attestation_state_v92"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if errors:
        print("AUDIO_CLEANUP_ATTESTATION_STATE_V92_INVALID")
        print("\n".join(f"- {error}" for error in errors))
        return 1
    print("AUDIO_CLEANUP_ATTESTATION_STATE_V92_VALID")
    return 0
