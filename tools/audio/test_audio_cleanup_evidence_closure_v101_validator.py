"""Focused tests for v101 evidence/closure summaries."""
...
import audio_cleanup_evidence_closure_v101_validator as validator  # noqa: E402


def summary() -> dict:
    evidence, closure = "a" * 64, "b" * 64
    def record(rid: str, artifact: str) -> dict:
        return {"record_id": rid, "evidence_digest": evidence, "closure_digest": closure, "evidence_id": "evidence-v101", "closure_id": "closure-v101", "canonicalization": "json-sorted-v1", "evidence": artifact, "closure_pass": True}
    return {"schema": "audio_cleanup_evidence_closure_v101", "revision": "a" * 40, "owner": "audio-evidence-owner", "summary_id": "cleanup-evidence-closure-v101", "evidence_bundle": "artifacts/audio/evidence-closure-v101.json", "canonicalization": "json-sorted-v1", "evidence_id": "evidence-v101", "closure_id": "closure-v101", "claim": "AUTOMATED_EVIDENCE_CLOSURE_ONLY", "boundary_note": "Evidence closure does not establish native audibility.", "record_ids": ["record-a", "record-b"], "evidence_digest": evidence, "closure_digest": closure, "records": [record("record-a", "artifacts/audio/a.json"), record("record-b", "artifacts/audio/b.json")], "evidence_closure_pass": True}


class AudioCleanupEvidenceClosureV101Tests(unittest.TestCase):
