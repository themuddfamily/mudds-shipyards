#!/usr/bin/env python3
"""Validate v95 attestation/lineage summaries."""
...
SCHEMA = "audio_cleanup_attestation_lineage_v95"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if errors:
        print("AUDIO_CLEANUP_ATTESTATION_LINEAGE_V95_INVALID")
        print("\n".join(f"- {error}" for error in errors))
        return 1
    print("AUDIO_CLEANUP_ATTESTATION_LINEAGE_V95_VALID")
    return 0
