"""Focused tests for v305 audio cleanup evidence/state summaries."""
import copy
import sys
import unittest
...
import audio_cleanup_evidence_state_v305_validator as validator  # noqa: E402
...
def summary() -> dict:
    ...
    return {
        ...
        "summary_id": "cleanup-evidence-state-v305",
        "evidence_bundle": "artifacts/audio/evidence-state-v305.json",
        "evidence_id": "evidence-v305",
        "state_model": "cleanup-state-v1",
        "state": "closed",
        "claim": "AUTOMATED_EVIDENCE_STATE_ONLY",
        "detached_status": "NOT_RUN",
...
class AudioCleanupEvidenceStateV305Tests(unittest.TestCase):
