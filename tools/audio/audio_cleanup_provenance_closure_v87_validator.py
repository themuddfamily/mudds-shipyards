#!/usr/bin/env python3
"""Validate v87 provenance/closure summaries."""
...
SCHEMA = "audio_cleanup_provenance_closure_v87"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if errors:
        print("AUDIO_CLEANUP_PROVENANCE_CLOSURE_V87_INVALID")
        print("\n".join(f"- {error}" for error in errors))
        return 1
    print("AUDIO_CLEANUP_PROVENANCE_CLOSURE_V87_VALID")
    return 0
