"""Focused tests for v155 audio cleanup evidence/state summaries."""
...
import audio_cleanup_evidence_state_v155_validator as validator  # noqa: E402
...
def summary() -> dict:
    ...
    def record(record_id: str, artifact: str) -> dict:
        return {"record_id": record_id, "evidence_digest": evidence, "state_digest": state_digest,
                "evidence_id": "evidence-v155", "state_model": "cleanup-state-v1", "state": "closed",
                "evidence": artifact, "state_pass": True}

    return {"schema": "audio_cleanup_evidence_state_v155", "revision": "a" * 40,
            "owner": "audio-evidence-owner", "summary_id": "cleanup-evidence-state-v155",
            "evidence_bundle": "artifacts/audio/evidence-state-v155.json", "evidence_id": "evidence-v155",
...
class AudioCleanupEvidenceStateV155Tests(unittest.TestCase):
