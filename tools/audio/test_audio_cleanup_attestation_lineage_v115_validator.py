"""Focused tests for v115 audio cleanup attestation/lineage summaries."""
...
import audio_cleanup_attestation_lineage_v115_validator as validator  # noqa: E402
...
def summary() -> dict:
    ...
    def record(record_id: str, leaf: str, artifact: str) -> dict:
        return {"record_id": record_id, "attestation_digest": attestation, "lineage_root": root,
                "lineage_leaf": leaf, "attestation_id": "attestation-v115", "lineage_id": "lineage-v1",
                "attestation": artifact, "lineage_pass": True}

    return {"schema": "audio_cleanup_attestation_lineage_v115", "revision": "a" * 40,
            "owner": "audio-attestation-owner", "summary_id": "cleanup-attestation-lineage-v115",
            "attestation_bundle": "artifacts/audio/attestation-lineage-v115.json",
            "attestation_id": "attestation-v115", "lineage_id": "lineage-v1",
...
class AudioCleanupAttestationLineageV115Tests(unittest.TestCase):
