"""Focused tests for v98 evidence/lineage summaries."""
...
import audio_cleanup_evidence_lineage_v98_validator as validator  # noqa: E402


def summary() -> dict:
    evidence, lineage = "a" * 64, "b" * 64
    def record(rid: str, artifact: str) -> dict:
        return {"record_id": rid, "evidence_digest": evidence, "lineage_digest": lineage, "evidence_id": "evidence-v98", "lineage_id": "lineage-v98", "canonicalization": "json-sorted-v1", "evidence": artifact, "lineage_pass": True}
    return {"schema": "audio_cleanup_evidence_lineage_v98", "revision": "a" * 40, "owner": "audio-evidence-owner", "summary_id": "cleanup-evidence-lineage-v98", "evidence_bundle": "artifacts/audio/evidence-lineage-v98.json", "canonicalization": "json-sorted-v1", "evidence_id": "evidence-v98", "lineage_id": "lineage-v98", "claim": "AUTOMATED_EVIDENCE_LINEAGE_ONLY", "boundary_note": "Evidence lineage does not establish native audibility.", "record_ids": ["record-a", "record-b"], "evidence_digest": evidence, "lineage_digest": lineage, "records": [record("record-a", "artifacts/audio/a.json"), record("record-b", "artifacts/audio/b.json")], "evidence_lineage_pass": True}


class AudioCleanupEvidenceLineageV98Tests(unittest.TestCase):
