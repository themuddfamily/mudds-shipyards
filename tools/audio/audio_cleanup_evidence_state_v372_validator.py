#!/usr/bin/env python3
"""Validate v372 audio cleanup evidence/state summaries without runtime claims."""
...
SCHEMA = "audio_cleanup_evidence_state_v372"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if errors:
        print("AUDIO_CLEANUP_EVIDENCE_STATE_V372_INVALID")
        print("\n".join(f"- {error}" for error in errors))
        return 1
    print("AUDIO_CLEANUP_EVIDENCE_STATE_V372_VALID")
    return 0
