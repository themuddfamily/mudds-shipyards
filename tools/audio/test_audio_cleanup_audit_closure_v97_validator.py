"""Focused tests for v97 audit/closure summaries."""
...
import audio_cleanup_audit_closure_v97_validator as validator  # noqa: E402


def summary() -> dict:
    audit, closure = "a" * 64, "b" * 64
    def record(rid: str, evidence: str) -> dict:
        return {"record_id": rid, "audit_digest": audit, "closure_digest": closure, "audit_id": "audit-v97", "closure_id": "closure-v97", "canonicalization": "json-sorted-v1", "evidence": evidence, "closure_pass": True}
    return {"schema": "audio_cleanup_audit_closure_v97", "revision": "a" * 40, "owner": "audio-evidence-owner", "summary_id": "cleanup-audit-closure-v97", "evidence_bundle": "artifacts/audio/audit-closure-v97.json", "canonicalization": "json-sorted-v1", "audit_id": "audit-v97", "closure_id": "closure-v97", "claim": "AUTOMATED_AUDIT_CLOSURE_ONLY", "boundary_note": "Audit closure does not establish native audibility.", "record_ids": ["record-a", "record-b"], "audit_digest": audit, "closure_digest": closure, "records": [record("record-a", "artifacts/audio/a.json"), record("record-b", "artifacts/audio/b.json")], "audit_closure_pass": True}


class AudioCleanupAuditClosureV97Tests(unittest.TestCase):
