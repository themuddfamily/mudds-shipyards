"""Focused tests for v109 audio cleanup evidence/lineage summaries."""
...
import audio_cleanup_evidence_lineage_v109_validator as validator  # noqa: E402
...
def summary() -> dict:
    ...
    def record(record_id: str, leaf: str, artifact: str) -> dict:
        return {"record_id": record_id, "evidence_digest": evidence, "lineage_root": root,
                "lineage_leaf": leaf, "evidence_id": "evidence-v109", "lineage_id": "lineage-v1",
                "evidence": artifact, "lineage_pass": True}

    return {"schema": "audio_cleanup_evidence_lineage_v109", "revision": "a" * 40,
            "owner": "audio-evidence-owner", "summary_id": "cleanup-evidence-lineage-v109",
            "evidence_bundle": "artifacts/audio/evidence-lineage-v109.json",
            "evidence_id": "evidence-v109", "lineage_id": "lineage-v1",
...
class AudioCleanupEvidenceLineageV109Tests(unittest.TestCase):
