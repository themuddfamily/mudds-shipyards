"""Focused tests for v165 audio cleanup evidence/state summaries."""
...
import audio_cleanup_evidence_state_v165_validator as validator  # noqa: E402
...
def summary() -> dict:
    ...
    def record(record_id: str, artifact: str) -> dict:
        return {"record_id": record_id, "evidence_digest": evidence, "state_digest": state_digest,
                "evidence_id": "evidence-v165", "state_model": "cleanup-state-v1", "state": "closed",
                "evidence": artifact, "state_pass": True}

    return {"schema": "audio_cleanup_evidence_state_v165", "revision": "a" * 40,
            "owner": "audio-evidence-owner", "summary_id": "cleanup-evidence-state-v165",
            "evidence_bundle": "artifacts/audio/evidence-state-v165.json", "evidence_id": "evidence-v165",
...
class AudioCleanupEvidenceStateV165Tests(unittest.TestCase):
