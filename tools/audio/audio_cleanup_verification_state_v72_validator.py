#!/usr/bin/env python3
"""Validate v72 verification/state summaries."""
...
SCHEMA = "audio_cleanup_verification_state_v72"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if errors:
        print("AUDIO_CLEANUP_VERIFICATION_STATE_V72_INVALID")
        print("\n".join(f"- {error}" for error in errors))
        return 1
    print("AUDIO_CLEANUP_VERIFICATION_STATE_V72_VALID")
    return 0
