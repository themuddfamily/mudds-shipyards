#!/usr/bin/env python3
"""Validate v100 audit/lineage summaries."""
...
SCHEMA = "audio_cleanup_audit_lineage_v100"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if errors:
        print("AUDIO_CLEANUP_AUDIT_LINEAGE_V100_INVALID")
        print("\n".join(f"- {error}" for error in errors))
        return 1
    print("AUDIO_CLEANUP_AUDIT_LINEAGE_V100_VALID")
    return 0
