#!/usr/bin/env python3
"""Validate v121 audio cleanup evidence/closure summaries."""
...
SCHEMA = "audio_cleanup_evidence_closure_v121"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if errors:
        print("AUDIO_CLEANUP_EVIDENCE_CLOSURE_V121_INVALID")
        print("\n".join(f"- {error}" for error in errors))
        return 1
    print("AUDIO_CLEANUP_EVIDENCE_CLOSURE_V121_VALID")
    return 0
