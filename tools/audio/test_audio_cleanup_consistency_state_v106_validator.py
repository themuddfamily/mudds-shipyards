"""Focused tests for v106 audio cleanup consistency/state summaries."""
...
import audio_cleanup_consistency_state_v106_validator as validator  # noqa: E402
...
def summary() -> dict:
    ...
    def record(record_id: str, artifact: str) -> dict:
        return {"record_id": record_id, "consistency_digest": consistency,
                "state_digest": state_digest, "consistency_id": "consistency-v106",
                "state_model": "cleanup-state-v1", "state": "closed",
                "consistency": artifact, "consistency_pass": True}

    return {"schema": "audio_cleanup_consistency_state_v106", "revision": "a" * 40,
            "owner": "audio-consistency-owner", "summary_id": "cleanup-consistency-state-v106",
            "consistency_bundle": "artifacts/audio/consistency-state-v106.json",
            "consistency_id": "consistency-v106", "state_model": "cleanup-state-v1",
...
class AudioCleanupConsistencyStateV106Tests(unittest.TestCase):
