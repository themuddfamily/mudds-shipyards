"""Focused tests for v178 audio cleanup evidence/state summaries."""
...
import audio_cleanup_evidence_state_v178_validator as validator  # noqa: E402
...
def summary() -> dict:
    ...
    def record(record_id: str, artifact: str) -> dict:
        return {"record_id": record_id, "evidence_digest": evidence, "state_digest": state_digest,
                "evidence_id": "evidence-v178", "state_model": "cleanup-state-v1", "state": "closed",
                "evidence": artifact, "state_pass": True}

    return {"schema": "audio_cleanup_evidence_state_v178", "revision": "a" * 40,
            "owner": "audio-evidence-owner", "summary_id": "cleanup-evidence-state-v178",
            "evidence_bundle": "artifacts/audio/evidence-state-v178.json", "evidence_id": "evidence-v178",
...
class AudioCleanupEvidenceStateV178Tests(unittest.TestCase):
