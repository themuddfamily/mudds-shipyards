#!/usr/bin/env python3
"""Validate v98 evidence/lineage summaries."""
...
SCHEMA = "audio_cleanup_evidence_lineage_v98"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if errors:
        print("AUDIO_CLEANUP_EVIDENCE_LINEAGE_V98_INVALID")
        print("\n".join(f"- {error}" for error in errors))
        return 1
    print("AUDIO_CLEANUP_EVIDENCE_LINEAGE_V98_VALID")
    return 0
