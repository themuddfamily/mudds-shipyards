"""Focused tests for v108 audio cleanup audit/state summaries."""
...
import audio_cleanup_audit_state_v108_validator as validator  # noqa: E402
...
def summary() -> dict:
    ...
    def record(record_id: str, artifact: str) -> dict:
        return {"record_id": record_id, "audit_digest": audit, "state_digest": state_digest,
                "audit_id": "audit-v108", "state_model": "cleanup-state-v1", "state": "closed",
                "audit": artifact, "audit_pass": True}

    return {"schema": "audio_cleanup_audit_state_v108", "revision": "a" * 40,
            "owner": "audio-audit-owner", "summary_id": "cleanup-audit-state-v108",
            "audit_bundle": "artifacts/audio/audit-state-v108.json", "audit_id": "audit-v108",
...
class AudioCleanupAuditStateV108Tests(unittest.TestCase):
