#!/usr/bin/env python3
"""Validate v307 audio cleanup evidence/state summaries without runtime claims."""
...
SCHEMA = "audio_cleanup_evidence_state_v307"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if errors:
        print("AUDIO_CLEANUP_EVIDENCE_STATE_V307_INVALID")
        print("\n".join(f"- {error}" for error in errors))
        return 1
    print("AUDIO_CLEANUP_EVIDENCE_STATE_V307_VALID")
    return 0
