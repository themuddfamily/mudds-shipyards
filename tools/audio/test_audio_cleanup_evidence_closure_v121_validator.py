"""Focused tests for v121 audio cleanup evidence/closure summaries."""
...
import audio_cleanup_evidence_closure_v121_validator as validator  # noqa: E402
...
def summary() -> dict:
    ...
    def record(record_id: str, artifact: str, close: str) -> dict:
        return {"record_id": record_id, "evidence_digest": evidence, "closure_digest": closure,
                "evidence_id": "evidence-v121", "closure_id": "closure-v121", "evidence": artifact,
                "closure": close, "closure_pass": True}

    return {"schema": "audio_cleanup_evidence_closure_v121", "revision": "a" * 40,
            "owner": "audio-evidence-owner", "summary_id": "cleanup-evidence-closure-v121",
            "evidence_bundle": "artifacts/audio/evidence-closure-v121.json", "evidence_id": "evidence-v121",
            "closure_id": "closure-v121", "claim": "AUTOMATED_EVIDENCE_CLOSURE_ONLY",
...
class AudioCleanupEvidenceClosureV121Tests(unittest.TestCase):
