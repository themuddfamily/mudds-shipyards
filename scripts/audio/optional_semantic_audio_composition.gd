...
func attach(audio_director: Node, cinder_craft: Node = null, cruise: Node = null) -> Dictionary:
	if _attached:
...
func get_snapshot() -> Dictionary:
	return {
		...
		"authority": {"role": false, "cargo": false, "cruise": false, "movement": false, "audio_cues": true},
	}.duplicate(true)
