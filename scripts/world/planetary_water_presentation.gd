...
func apply_presentation_recipe(solar_snapshot: Variant, weather_snapshot: Variant) -> Dictionary:
	...
	_material.set_shader_parameter("wave_strength", clampf(0.05 + wind_value.length() / 1000.0 * 0.25, 0.05, 0.3))
