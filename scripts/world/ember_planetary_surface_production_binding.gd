...
## cruise hands off final approach. Host.start() advances the run generation
## exactly once; the scheduler forwards that committed fact before admitting
## any surface activity or observation.
