...
func _build_entity_visuals() -> void:
	...
	_box("PortCargoPod", Vector3(2.15, 2.5, 6.4), Vector3(-3.35, 0.05, 0.4), cargo_material)
	_box("StarboardCargoPod", Vector3(2.15, 2.5, 6.4), Vector3(3.35, 0.05, 0.4), cargo_material)
