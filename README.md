...
godot --headless --path . --script res://tests/combat_audio_presentation_test.gd
godot --headless --path . --script res://tests/combat_receipt_identity_test.gd
...
godot --headless --path . --script res://tests/wing_coordinator_test.gd
godot --headless --path . --script res://tests/encounter_scenario_director_test.gd
godot --headless --path . --script res://tests/opponent_role_differentiation_test.gd
godot --headless --path . --script res://tests/opponent_presentation_coverage_test.gd
godot --headless --path . --script res://tests/varied_encounter_integration_test.gd
...
godot --headless --path . --script res://tests/station_module_contract_test.gd
godot --headless --path . --script res://tests/station_route_registry_integration_test.gd
...
# Set GODOT_BIN to select a non-default Godot executable; an optional output
# path is accepted only beneath builds/windows/ and is never overwritten.
